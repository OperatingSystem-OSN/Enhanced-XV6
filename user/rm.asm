...
main(int argc, char *argv[])
{
  ...
  42:	81258593          	addi	a1,a1,-2030 # 850 <malloc+0xe8>
  46:	4509                	li	a0,2
  ...
  60:	80c58593          	addi	a1,a1,-2036 # 868 <malloc+0x100>
  64:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 3ec:	f36080e7          	jalr	-202(ra) # 31e <write>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4de:	3b6c8c93          	addi	s9,s9,950 # 890 <malloc+0x128>
 ...
 4ec:	400b8b93          	addi	s7,s7,1024 # 8e8 <digits>
 ...
 612:	27a98993          	addi	s3,s3,634 # 888 <malloc+0x120>
        while(*s != 0){
 616:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 842:	b48080e7          	jalr	-1208(ra) # 386 <sbrk>
  if(p == (char*)-1)
