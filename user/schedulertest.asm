...
int main()
{
  ...
  2a:	416080e7          	jalr	1046(ra) # 43c <set_priority>
    for (n = 0; n < NFORK; n++)
  ...
  50:	89c50513          	addi	a0,a0,-1892 # 8e8 <malloc+0x10a>
  54:	00000097          	auipc	ra,0x0
  58:	6d2080e7          	jalr	1746(ra) # 726 <printf>
    exit(0);
  5c:	4501                	li	a0,0
  ...
  a6:	684080e7          	jalr	1668(ra) # 726 <printf>
            exit(0);
  aa:	4501                	li	a0,0
  ...
  c6:	fcc40613          	addi	a2,s0,-52
  ca:	fc840593          	addi	a1,s0,-56
  ce:	4501                	li	a0,0
  d0:	00000097          	auipc	ra,0x0
  d4:	364080e7          	jalr	868(ra) # 434 <waitx>
...
putc(int fd, char c)
{
 ...
 462:	f36080e7          	jalr	-202(ra) # 394 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 494:	4d850513          	addi	a0,a0,1240 # 968 <digits>
 498:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 554:	3c0c8c93          	addi	s9,s9,960 # 910 <malloc+0x132>
 ...
 562:	40ab8b93          	addi	s7,s7,1034 # 968 <digits>
 ...
 688:	28498993          	addi	s3,s3,644 # 908 <malloc+0x12a>
        while(*s != 0){
 68c:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 8b8:	b48080e7          	jalr	-1208(ra) # 3fc <sbrk>
  if(p == (char*)-1)
