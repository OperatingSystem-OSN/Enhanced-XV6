...
main(int argc, char *argv[])
{
  ...
  2e:	836a0a13          	addi	s4,s4,-1994 # 860 <malloc+0xec>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	80058593          	addi	a1,a1,-2048 # 868 <malloc+0xf4>
  70:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 3f8:	f36080e7          	jalr	-202(ra) # 32a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42a:	4aa50513          	addi	a0,a0,1194 # 8d0 <digits>
 42e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ea:	392c8c93          	addi	s9,s9,914 # 878 <malloc+0x104>
 ...
 4f8:	3dcb8b93          	addi	s7,s7,988 # 8d0 <digits>
 ...
 61e:	25698993          	addi	s3,s3,598 # 870 <malloc+0xfc>
        while(*s != 0){
 622:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 84e:	b48080e7          	jalr	-1208(ra) # 392 <sbrk>
  if(p == (char*)-1)
