...
periodic()
{
  ...
  1e:	c2650513          	addi	a0,a0,-986 # c40 <malloc+0xec>
...
slow_handler()
{
  ...
  5c:	be850513          	addi	a0,a0,-1048 # c40 <malloc+0xec>
  ...
  a2:	baa50513          	addi	a0,a0,-1110 # c48 <malloc+0xf4>
...
00000000000000dc <test0>:
{
  ...
  f2:	b9250513          	addi	a0,a0,-1134 # c80 <malloc+0x12c>
 ...
 126:	b6ea8a93          	addi	s5,s5,-1170 # c90 <malloc+0x13c>
    if(count > 0)
 ...
 17e:	b1e50513          	addi	a0,a0,-1250 # c98 <malloc+0x144>
 ...
 1a0:	b0c50513          	addi	a0,a0,-1268 # ca8 <malloc+0x154>
...
void __attribute__ ((noinline)) foo(int i, int *j) {
 ...
 1de:	ab658593          	addi	a1,a1,-1354 # c90 <malloc+0x13c>
 1e2:	4509                	li	a0,2
...
00000000000001ee <test1>:
{
 ...
 202:	aea50513          	addi	a0,a0,-1302 # ce8 <malloc+0x194>
 ...
 278:	ab450513          	addi	a0,a0,-1356 # d28 <malloc+0x1d4>
...
00000000000002b8 <test2>:
{
 ...
 2ce:	aae50513          	addi	a0,a0,-1362 # d78 <malloc+0x224>
 ...
 310:	984a8a93          	addi	s5,s5,-1660 # c90 <malloc+0x13c>
      if(count > 0)
 ...
 32a:	a6250513          	addi	a0,a0,-1438 # d88 <malloc+0x234>
 ...
 38e:	a1650513          	addi	a0,a0,-1514 # da0 <malloc+0x24c>
 ...
 3b2:	a1a50513          	addi	a0,a0,-1510 # dc8 <malloc+0x274>
...
test3()
{
 ...
 3de:	9fe50513          	addi	a0,a0,-1538 # dd8 <malloc+0x284>
 ...
 40c:	9e050513          	addi	a0,a0,-1568 # de8 <malloc+0x294>
 ...
 424:	9f050513          	addi	a0,a0,-1552 # e10 <malloc+0x2bc>
...
putc(int fd, char c)
{
 ...
 7d8:	f36080e7          	jalr	-202(ra) # 70a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7f2:	84aa                	mv	s1,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 7f4:	c299                	beqz	a3,7fa <printint+0x16>
 7f6:	0805c963          	bltz	a1,888 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 7fa:	2581                	sext.w	a1,a1
  neg = 0;
 7fc:	4881                	li	a7,0
 7fe:	fc040693          	addi	a3,s0,-64
  }
 ...
 802:	4701                	li	a4,0
  do{
    buf[i++] = digits[x % base];
 804:	2601                	sext.w	a2,a2
 806:	00000517          	auipc	a0,0x0
 80a:	67a50513          	addi	a0,a0,1658 # e80 <digits>
 80e:	883a                	mv	a6,a4
 810:	2705                	addiw	a4,a4,1
 812:	02c5f7bb          	remuw	a5,a1,a2
 816:	1782                	slli	a5,a5,0x20
 818:	9381                	srli	a5,a5,0x20
 81a:	97aa                	add	a5,a5,a0
 81c:	0007c783          	lbu	a5,0(a5)
 820:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
 824:	0005879b          	sext.w	a5,a1
 828:	02c5d5bb          	divuw	a1,a1,a2
 82c:	0685                	addi	a3,a3,1
 82e:	fec7f0e3          	bgeu	a5,a2,80e <printint+0x2a>
  if(neg)
 832:	00088c63          	beqz	a7,84a <printint+0x66>
    buf[i++] = '-';
 836:	fd070793          	addi	a5,a4,-48
 83a:	00878733          	add	a4,a5,s0
 83e:	02d00793          	li	a5,45
 842:	fef70823          	sb	a5,-16(a4)
 846:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
 84a:	02e05863          	blez	a4,87a <printint+0x96>
 ...
 870:	f56080e7          	jalr	-170(ra) # 7c2 <putc>
  while(--i >= 0)
 874:	197d                	addi	s2,s2,-1
 876:	ff3918e3          	bne	s2,s3,866 <printint+0x82>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 8c4:	4c55                	li	s8,21
 8c6:	00000c97          	auipc	s9,0x0
 8ca:	562c8c93          	addi	s9,s9,1378 # e28 <malloc+0x2d4>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 8ce:	02800d93          	li	s11,40
  putc(fd, 'x');
 8d2:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 8d4:	00000b97          	auipc	s7,0x0
 8d8:	5acb8b93          	addi	s7,s7,1452 # e80 <digits>
 8dc:	a839                	j	8fa <vprintf+0x6a>
        putc(fd, c);
 8de:	85ca                	mv	a1,s2
 8e0:	8556                	mv	a0,s5
 8e2:	00000097          	auipc	ra,0x0
 8e6:	ee0080e7          	jalr	-288(ra) # 7c2 <putc>
 8ea:	a019                	j	8f0 <vprintf+0x60>
    } else if(state == '%'){
 8ec:	01498d63          	beq	s3,s4,906 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
 8f0:	0485                	addi	s1,s1,1
 8f2:	fff4c903          	lbu	s2,-1(s1)
 8f6:	14090d63          	beqz	s2,a50 <vprintf+0x1c0>
    if(state == 0){
 8fa:	fe0999e3          	bnez	s3,8ec <vprintf+0x5c>
      if(c == '%'){
 8fe:	ff4910e3          	bne	s2,s4,8de <vprintf+0x4e>
        state = '%';
 902:	89d2                	mv	s3,s4
 904:	b7f5                	j	8f0 <vprintf+0x60>
      if(c == 'd'){
 906:	11490c63          	beq	s2,s4,a1e <vprintf+0x18e>
 90a:	f9d9079b          	addiw	a5,s2,-99
 90e:	0ff7f793          	zext.b	a5,a5
 912:	10fc6e63          	bltu	s8,a5,a2e <vprintf+0x19e>
 916:	f9d9079b          	addiw	a5,s2,-99
 91a:	0ff7f713          	zext.b	a4,a5
 91e:	10ec6863          	bltu	s8,a4,a2e <vprintf+0x19e>
 922:	00271793          	slli	a5,a4,0x2
 926:	97e6                	add	a5,a5,s9
 928:	439c                	lw	a5,0(a5)
 ...
 932:	4685                	li	a3,1
 934:	4629                	li	a2,10
 936:	000b2583          	lw	a1,0(s6)
 93a:	8556                	mv	a0,s5
 93c:	00000097          	auipc	ra,0x0
 940:	ea8080e7          	jalr	-344(ra) # 7e4 <printint>
 944:	8b4a                	mv	s6,s2
      } else {
 ...
 95c:	e8c080e7          	jalr	-372(ra) # 7e4 <printint>
 960:	8b4a                	mv	s6,s2
      state = 0;
 962:	4981                	li	s3,0
 ...
 978:	e70080e7          	jalr	-400(ra) # 7e4 <printint>
 97c:	8b4a                	mv	s6,s2
      state = 0;
 97e:	4981                	li	s3,0
 980:	bf85                	j	8f0 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 982:	008b0793          	addi	a5,s6,8
 986:	f8f43423          	sd	a5,-120(s0)
 98a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
 98e:	03000593          	li	a1,48
 992:	8556                	mv	a0,s5
 994:	00000097          	auipc	ra,0x0
 998:	e2e080e7          	jalr	-466(ra) # 7c2 <putc>
  putc(fd, 'x');
 99c:	07800593          	li	a1,120
 9a0:	8556                	mv	a0,s5
 9a2:	00000097          	auipc	ra,0x0
 9a6:	e20080e7          	jalr	-480(ra) # 7c2 <putc>
 9aa:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 9bc:	e0a080e7          	jalr	-502(ra) # 7c2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 9c0:	0992                	slli	s3,s3,0x4
 9c2:	397d                	addiw	s2,s2,-1
 9c4:	fe0914e3          	bnez	s2,9ac <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
 9c8:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 9cc:	4981                	li	s3,0
 9ce:	b70d                	j	8f0 <vprintf+0x60>
        s = va_arg(ap, char*);
 9d0:	008b0913          	addi	s2,s6,8
 9d4:	000b3983          	ld	s3,0(s6)
        if(s == 0)
 9d8:	02098163          	beqz	s3,9fa <vprintf+0x16a>
        while(*s != 0){
 9dc:	0009c583          	lbu	a1,0(s3)
 9e0:	c5ad                	beqz	a1,a4a <vprintf+0x1ba>
          putc(fd, *s);
 9e2:	8556                	mv	a0,s5
 9e4:	00000097          	auipc	ra,0x0
 9e8:	dde080e7          	jalr	-546(ra) # 7c2 <putc>
          s++;
 9ec:	0985                	addi	s3,s3,1
        while(*s != 0){
 9ee:	0009c583          	lbu	a1,0(s3)
 9f2:	f9e5                	bnez	a1,9e2 <vprintf+0x152>
        s = va_arg(ap, char*);
 9f4:	8b4a                	mv	s6,s2
      state = 0;
 9f6:	4981                	li	s3,0
 9f8:	bde5                	j	8f0 <vprintf+0x60>
          s = "(null)";
 9fa:	00000997          	auipc	s3,0x0
 9fe:	42698993          	addi	s3,s3,1062 # e20 <malloc+0x2cc>
        while(*s != 0){
 a02:	85ee                	mv	a1,s11
 a04:	bff9                	j	9e2 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
 a06:	008b0913          	addi	s2,s6,8
 a0a:	000b4583          	lbu	a1,0(s6)
 a0e:	8556                	mv	a0,s5
 a10:	00000097          	auipc	ra,0x0
 a14:	db2080e7          	jalr	-590(ra) # 7c2 <putc>
 a18:	8b4a                	mv	s6,s2
      state = 0;
 a1a:	4981                	li	s3,0
 a1c:	bdd1                	j	8f0 <vprintf+0x60>
        putc(fd, c);
 a1e:	85d2                	mv	a1,s4
 a20:	8556                	mv	a0,s5
 a22:	00000097          	auipc	ra,0x0
 a26:	da0080e7          	jalr	-608(ra) # 7c2 <putc>
      state = 0;
 a2a:	4981                	li	s3,0
 a2c:	b5d1                	j	8f0 <vprintf+0x60>
        putc(fd, '%');
 a2e:	85d2                	mv	a1,s4
 a30:	8556                	mv	a0,s5
 a32:	00000097          	auipc	ra,0x0
 a36:	d90080e7          	jalr	-624(ra) # 7c2 <putc>
        putc(fd, c);
 a3a:	85ca                	mv	a1,s2
 a3c:	8556                	mv	a0,s5
 a3e:	00000097          	auipc	ra,0x0
 a42:	d84080e7          	jalr	-636(ra) # 7c2 <putc>
      state = 0;
 a46:	4981                	li	s3,0
 ...
 b08:	00e6ea63          	bltu	a3,a4,b1c <free+0x4a>
{
 ...
 b4a:	4cf73123          	sd	a5,1218(a4) # 1008 <freep>
}
 b4e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 b7c:	49053503          	ld	a0,1168(a0) # 1008 <freep>
 ...
 ba4:	46890913          	addi	s2,s2,1128 # 1008 <freep>
  if(p == (char*)-1)
 ba8:	5afd                	li	s5,-1
 baa:	a895                	j	c1e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 bac:	00000797          	auipc	a5,0x0
 bb0:	46478793          	addi	a5,a5,1124 # 1010 <base>
 ...
 be0:	42a73623          	sd	a0,1068(a4) # 1008 <freep>
      return (void*)(p + 1);
 ...
 c2e:	b48080e7          	jalr	-1208(ra) # 772 <sbrk>
  if(p == (char*)-1)
