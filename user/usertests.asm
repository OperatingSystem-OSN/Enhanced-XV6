...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0d250513          	addi	a0,a0,210 # 6110 <malloc+0xe6>
      ...
      74:	8082                	ret
{
      ...
      84:	0b050513          	addi	a0,a0,176 # 6130 <malloc+0x106>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0a050513          	addi	a0,a0,160 # 6148 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0a250513          	addi	a0,a0,162 # 6168 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	06a50513          	addi	a0,a0,106 # 6150 <malloc+0x126>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	07650513          	addi	a0,a0,118 # 6178 <malloc+0x14e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	07450513          	addi	a0,a0,116 # 61a0 <malloc+0x176>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	06050513          	addi	a0,a0,96 # 61a0 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	05c58593          	addi	a1,a1,92 # 61b0 <malloc+0x186>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	03850513          	addi	a0,a0,56 # 61a0 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	03c58593          	addi	a1,a1,60 # 61b8 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	00c50513          	addi	a0,a0,12 # 61a0 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	ff650513          	addi	a0,a0,-10 # 61c0 <malloc+0x196>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f6c50513          	addi	a0,a0,-148 # 61e8 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f58a8a93          	addi	s5,s5,-168 # 61e8 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ee650513          	addi	a0,a0,-282 # 61f8 <malloc+0x1ce>
     ...
     338:	ee450513          	addi	a0,a0,-284 # 6218 <malloc+0x1ee>
     33c:	00006097          	auipc	ra,0x6
     340:	c36080e7          	jalr	-970(ra) # 5f72 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ed250513          	addi	a0,a0,-302 # 6230 <malloc+0x206>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	ebe98993          	addi	s3,s3,-322 # 6230 <malloc+0x206>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e7250513          	addi	a0,a0,-398 # 6230 <malloc+0x206>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	de258593          	addi	a1,a1,-542 # 61b8 <malloc+0x18e>
    ...
    printf("write failed\n");
     ...
     3f0:	e6450513          	addi	a0,a0,-412 # 6250 <malloc+0x226>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b7e080e7          	jalr	-1154(ra) # 5f72 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	e3250513          	addi	a0,a0,-462 # 6238 <malloc+0x20e>
     40e:	00006097          	auipc	ra,0x6
     412:	b64080e7          	jalr	-1180(ra) # 5f72 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	e1850513          	addi	a0,a0,-488 # 6238 <malloc+0x20e>
     428:	00006097          	auipc	ra,0x6
     42c:	b4a080e7          	jalr	-1206(ra) # 5f72 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	dec50513          	addi	a0,a0,-532 # 6230 <malloc+0x206>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d10a0a13          	addi	s4,s4,-752 # 6260 <malloc+0x236>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c6c50513          	addi	a0,a0,-916 # 6268 <malloc+0x23e>
     604:	00006097          	auipc	ra,0x6
     608:	96e080e7          	jalr	-1682(ra) # 5f72 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c6650513          	addi	a0,a0,-922 # 6280 <malloc+0x256>
     622:	00006097          	auipc	ra,0x6
     626:	950080e7          	jalr	-1712(ra) # 5f72 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c7850513          	addi	a0,a0,-904 # 62b0 <malloc+0x286>
     640:	00006097          	auipc	ra,0x6
     644:	932080e7          	jalr	-1742(ra) # 5f72 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c8e50513          	addi	a0,a0,-882 # 62e0 <malloc+0x2b6>
     65a:	00006097          	auipc	ra,0x6
     65e:	918080e7          	jalr	-1768(ra) # 5f72 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c8050513          	addi	a0,a0,-896 # 62f0 <malloc+0x2c6>
     678:	00006097          	auipc	ra,0x6
     67c:	8fa080e7          	jalr	-1798(ra) # 5f72 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c72a0a13          	addi	s4,s4,-910 # 6320 <malloc+0x2f6>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b02a8a93          	addi	s5,s5,-1278 # 61b8 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bcc50513          	addi	a0,a0,-1076 # 6328 <malloc+0x2fe>
     764:	00006097          	auipc	ra,0x6
     768:	80e080e7          	jalr	-2034(ra) # 5f72 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	bc650513          	addi	a0,a0,-1082 # 6340 <malloc+0x316>
     782:	00005097          	auipc	ra,0x5
     786:	7f0080e7          	jalr	2032(ra) # 5f72 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b4c50513          	addi	a0,a0,-1204 # 62e0 <malloc+0x2b6>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7d6080e7          	jalr	2006(ra) # 5f72 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	bc250513          	addi	a0,a0,-1086 # 6370 <malloc+0x346>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	7bc080e7          	jalr	1980(ra) # 5f72 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	bbc50513          	addi	a0,a0,-1092 # 6388 <malloc+0x35e>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	79e080e7          	jalr	1950(ra) # 5f72 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	98e58593          	addi	a1,a1,-1650 # 61b0 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	96250513          	addi	a0,a0,-1694 # 61a0 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	93650513          	addi	a0,a0,-1738 # 61a0 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	92250513          	addi	a0,a0,-1758 # 61a0 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b5c58593          	addi	a1,a1,-1188 # 6418 <malloc+0x3ee>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8a250513          	addi	a0,a0,-1886 # 61a0 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a7650513          	addi	a0,a0,-1418 # 63b8 <malloc+0x38e>
     94a:	00005097          	auipc	ra,0x5
     94e:	628080e7          	jalr	1576(ra) # 5f72 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a7a50513          	addi	a0,a0,-1414 # 63d8 <malloc+0x3ae>
     966:	00005097          	auipc	ra,0x5
     96a:	60c080e7          	jalr	1548(ra) # 5f72 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a7650513          	addi	a0,a0,-1418 # 63e8 <malloc+0x3be>
     97a:	00005097          	auipc	ra,0x5
     97e:	5f8080e7          	jalr	1528(ra) # 5f72 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a7a50513          	addi	a0,a0,-1414 # 6408 <malloc+0x3de>
     996:	00005097          	auipc	ra,0x5
     99a:	5dc080e7          	jalr	1500(ra) # 5f72 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a4650513          	addi	a0,a0,-1466 # 63e8 <malloc+0x3be>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	5c8080e7          	jalr	1480(ra) # 5f72 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a6050513          	addi	a0,a0,-1440 # 6420 <malloc+0x3f6>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	5aa080e7          	jalr	1450(ra) # 5f72 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a6250513          	addi	a0,a0,-1438 # 6440 <malloc+0x416>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	58c080e7          	jalr	1420(ra) # 5f72 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a4e50513          	addi	a0,a0,-1458 # 6460 <malloc+0x436>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a5e98993          	addi	s3,s3,-1442 # 6488 <malloc+0x45e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a8ea8a93          	addi	s5,s5,-1394 # 64c0 <malloc+0x496>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9e850513          	addi	a0,a0,-1560 # 6460 <malloc+0x436>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9ac50513          	addi	a0,a0,-1620 # 6460 <malloc+0x436>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	98a50513          	addi	a0,a0,-1654 # 6468 <malloc+0x43e>
     ae6:	00005097          	auipc	ra,0x5
     aea:	48c080e7          	jalr	1164(ra) # 5f72 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	99c50513          	addi	a0,a0,-1636 # 6498 <malloc+0x46e>
     b04:	00005097          	auipc	ra,0x5
     b08:	46e080e7          	jalr	1134(ra) # 5f72 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	9b650513          	addi	a0,a0,-1610 # 64d0 <malloc+0x4a6>
     b22:	00005097          	auipc	ra,0x5
     b26:	450080e7          	jalr	1104(ra) # 5f72 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9c250513          	addi	a0,a0,-1598 # 64f8 <malloc+0x4ce>
     b3e:	00005097          	auipc	ra,0x5
     b42:	434080e7          	jalr	1076(ra) # 5f72 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9c650513          	addi	a0,a0,-1594 # 6518 <malloc+0x4ee>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	418080e7          	jalr	1048(ra) # 5f72 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9c250513          	addi	a0,a0,-1598 # 6530 <malloc+0x506>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3fc080e7          	jalr	1020(ra) # 5f72 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9b050513          	addi	a0,a0,-1616 # 6550 <malloc+0x526>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	95e50513          	addi	a0,a0,-1698 # 6550 <malloc+0x526>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	91e50513          	addi	a0,a0,-1762 # 6558 <malloc+0x52e>
     c42:	00005097          	auipc	ra,0x5
     c46:	330080e7          	jalr	816(ra) # 5f72 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	92050513          	addi	a0,a0,-1760 # 6578 <malloc+0x54e>
     c60:	00005097          	auipc	ra,0x5
     c64:	312080e7          	jalr	786(ra) # 5f72 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	92c50513          	addi	a0,a0,-1748 # 65a0 <malloc+0x576>
     c7c:	00005097          	auipc	ra,0x5
     c80:	2f6080e7          	jalr	758(ra) # 5f72 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8b050513          	addi	a0,a0,-1872 # 6550 <malloc+0x526>
     ...
     cd0:	8f450513          	addi	a0,a0,-1804 # 65c0 <malloc+0x596>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	29e080e7          	jalr	670(ra) # 5f72 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	8fe50513          	addi	a0,a0,-1794 # 65e8 <malloc+0x5be>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	280080e7          	jalr	640(ra) # 5f72 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	8f850513          	addi	a0,a0,-1800 # 6600 <malloc+0x5d6>
     d10:	00005097          	auipc	ra,0x5
     d14:	262080e7          	jalr	610(ra) # 5f72 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	90450513          	addi	a0,a0,-1788 # 6628 <malloc+0x5fe>
     d2c:	00005097          	auipc	ra,0x5
     d30:	246080e7          	jalr	582(ra) # 5f72 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8ee50513          	addi	a0,a0,-1810 # 6640 <malloc+0x616>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	90658593          	addi	a1,a1,-1786 # 6670 <malloc+0x646>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ba50513          	addi	a0,a0,-1862 # 6640 <malloc+0x616>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8a450513          	addi	a0,a0,-1884 # 6640 <malloc+0x616>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	88e50513          	addi	a0,a0,-1906 # 6640 <malloc+0x616>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8f258593          	addi	a1,a1,-1806 # 66b8 <malloc+0x68e>
  ...
  unlink("unlinkread");
     ...
     e32:	81250513          	addi	a0,a0,-2030 # 6640 <malloc+0x616>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	80250513          	addi	a0,a0,-2046 # 6650 <malloc+0x626>
     e56:	00005097          	auipc	ra,0x5
     e5a:	11c080e7          	jalr	284(ra) # 5f72 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	80e50513          	addi	a0,a0,-2034 # 6678 <malloc+0x64e>
     e72:	00005097          	auipc	ra,0x5
     e76:	100080e7          	jalr	256(ra) # 5f72 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	81250513          	addi	a0,a0,-2030 # 6698 <malloc+0x66e>
     e8e:	00005097          	auipc	ra,0x5
     e92:	0e4080e7          	jalr	228(ra) # 5f72 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	81e50513          	addi	a0,a0,-2018 # 66c0 <malloc+0x696>
     eaa:	00005097          	auipc	ra,0x5
     eae:	0c8080e7          	jalr	200(ra) # 5f72 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	82250513          	addi	a0,a0,-2014 # 66e0 <malloc+0x6b6>
     ec6:	00005097          	auipc	ra,0x5
     eca:	0ac080e7          	jalr	172(ra) # 5f72 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	82650513          	addi	a0,a0,-2010 # 6700 <malloc+0x6d6>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	090080e7          	jalr	144(ra) # 5f72 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	73258593          	addi	a1,a1,1842 # 6670 <malloc+0x646>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7ca58593          	addi	a1,a1,1994 # 6728 <malloc+0x6fe>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ba50513          	addi	a0,a0,1978 # 6720 <malloc+0x6f6>
  ...
  unlink("lf1");
     ...
     f7e:	7a650513          	addi	a0,a0,1958 # 6720 <malloc+0x6f6>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	79450513          	addi	a0,a0,1940 # 6720 <malloc+0x6f6>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	78650513          	addi	a0,a0,1926 # 6728 <malloc+0x6fe>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	74e58593          	addi	a1,a1,1870 # 6728 <malloc+0x6fe>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	73850513          	addi	a0,a0,1848 # 6728 <malloc+0x6fe>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	72058593          	addi	a1,a1,1824 # 6720 <malloc+0x6f6>
    1008:	00005517          	auipc	a0,0x5
    100c:	72050513          	addi	a0,a0,1824 # 6728 <malloc+0x6fe>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	70458593          	addi	a1,a1,1796 # 6720 <malloc+0x6f6>
    1024:	00006517          	auipc	a0,0x6
    1028:	80c50513          	addi	a0,a0,-2036 # 6830 <malloc+0x806>
    ...
    104a:	6ea50513          	addi	a0,a0,1770 # 6730 <malloc+0x706>
    104e:	00005097          	auipc	ra,0x5
    1052:	f24080e7          	jalr	-220(ra) # 5f72 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	6e650513          	addi	a0,a0,1766 # 6748 <malloc+0x71e>
    106a:	00005097          	auipc	ra,0x5
    106e:	f08080e7          	jalr	-248(ra) # 5f72 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	6e250513          	addi	a0,a0,1762 # 6760 <malloc+0x736>
    1086:	00005097          	auipc	ra,0x5
    108a:	eec080e7          	jalr	-276(ra) # 5f72 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	6e650513          	addi	a0,a0,1766 # 6780 <malloc+0x756>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	ed0080e7          	jalr	-304(ra) # 5f72 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	6fa50513          	addi	a0,a0,1786 # 67b0 <malloc+0x786>
    10be:	00005097          	auipc	ra,0x5
    10c2:	eb4080e7          	jalr	-332(ra) # 5f72 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	6f650513          	addi	a0,a0,1782 # 67c8 <malloc+0x79e>
    10da:	00005097          	auipc	ra,0x5
    10de:	e98080e7          	jalr	-360(ra) # 5f72 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6f250513          	addi	a0,a0,1778 # 67e0 <malloc+0x7b6>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e7c080e7          	jalr	-388(ra) # 5f72 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	6fe50513          	addi	a0,a0,1790 # 6808 <malloc+0x7de>
    1112:	00005097          	auipc	ra,0x5
    1116:	e60080e7          	jalr	-416(ra) # 5f72 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	71250513          	addi	a0,a0,1810 # 6838 <malloc+0x80e>
    112e:	00005097          	auipc	ra,0x5
    1132:	e44080e7          	jalr	-444(ra) # 5f72 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	70098993          	addi	s3,s3,1792 # 6858 <malloc+0x82e>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6d450513          	addi	a0,a0,1748 # 6868 <malloc+0x83e>
    119c:	00005097          	auipc	ra,0x5
    11a0:	dd6080e7          	jalr	-554(ra) # 5f72 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	68ea0a13          	addi	s4,s4,1678 # 6888 <malloc+0x85e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	63c50513          	addi	a0,a0,1596 # 6888 <malloc+0x85e>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5d450513          	addi	a0,a0,1492 # 6890 <malloc+0x866>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	cae080e7          	jalr	-850(ra) # 5f72 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	5d450513          	addi	a0,a0,1492 # 68b0 <malloc+0x886>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c8e080e7          	jalr	-882(ra) # 5f72 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	5d850513          	addi	a0,a0,1496 # 68d0 <malloc+0x8a6>
    1300:	00005097          	auipc	ra,0x5
    1304:	c72080e7          	jalr	-910(ra) # 5f72 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	de498993          	addi	s3,s3,-540 # 6148 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	73a78793          	addi	a5,a5,1850 # 7b28 <malloc+0x1afe>
  ...
  if(pid == 0){
    ...
    144e:	11e78793          	addi	a5,a5,286 # 8568 <malloc+0x253e>
    ...
    1472:	cda50513          	addi	a0,a0,-806 # 6148 <malloc+0x11e>
    ...
    148a:	4f250513          	addi	a0,a0,1266 # 6978 <malloc+0x94e>
    148e:	00005097          	auipc	ra,0x5
    1492:	ae4080e7          	jalr	-1308(ra) # 5f72 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	44a50513          	addi	a0,a0,1098 # 68f0 <malloc+0x8c6>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	ac4080e7          	jalr	-1340(ra) # 5f72 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	44a50513          	addi	a0,a0,1098 # 6910 <malloc+0x8e6>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	aa4080e7          	jalr	-1372(ra) # 5f72 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	44850513          	addi	a0,a0,1096 # 6930 <malloc+0x906>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a82080e7          	jalr	-1406(ra) # 5f72 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	45050513          	addi	a0,a0,1104 # 6958 <malloc+0x92e>
    1510:	00005097          	auipc	ra,0x5
    1514:	a62080e7          	jalr	-1438(ra) # 5f72 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	8b650513          	addi	a0,a0,-1866 # 6dd8 <malloc+0xdae>
    152a:	00005097          	auipc	ra,0x5
    152e:	a48080e7          	jalr	-1464(ra) # 5f72 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	43450513          	addi	a0,a0,1076 # 69a0 <malloc+0x976>
    1574:	00005097          	auipc	ra,0x5
    1578:	9fe080e7          	jalr	-1538(ra) # 5f72 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c0250513          	addi	a0,a0,-1022 # 61a0 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    15cc:	bd8a0a13          	addi	s4,s4,-1064 # 61a0 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	430a8a93          	addi	s5,s5,1072 # 6a00 <malloc+0x9d6>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	39050513          	addi	a0,a0,912 # 69d0 <malloc+0x9a6>
    1648:	00005097          	auipc	ra,0x5
    164c:	92a080e7          	jalr	-1750(ra) # 5f72 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	38c50513          	addi	a0,a0,908 # 69e8 <malloc+0x9be>
    1664:	00005097          	auipc	ra,0x5
    1668:	90e080e7          	jalr	-1778(ra) # 5f72 <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	39650513          	addi	a0,a0,918 # 6a10 <malloc+0x9e6>
    1682:	00005097          	auipc	ra,0x5
    1686:	8f0080e7          	jalr	-1808(ra) # 5f72 <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	b08a0a13          	addi	s4,s4,-1272 # 61a0 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	390a8a93          	addi	s5,s5,912 # 6a30 <malloc+0xa06>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	ab650513          	addi	a0,a0,-1354 # 61a0 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    170c:	2e050513          	addi	a0,a0,736 # 69e8 <malloc+0x9be>
    1710:	00005097          	auipc	ra,0x5
    1714:	862080e7          	jalr	-1950(ra) # 5f72 <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	31250513          	addi	a0,a0,786 # 6a38 <malloc+0xa0e>
    172e:	00005097          	auipc	ra,0x5
    1732:	844080e7          	jalr	-1980(ra) # 5f72 <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9fa78793          	addi	a5,a5,-1542 # 6148 <malloc+0x11e>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2fe78793          	addi	a5,a5,766 # 6a58 <malloc+0xa2e>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2f650513          	addi	a0,a0,758 # 6a60 <malloc+0xa36>
  ...
  if(pid == 0) {
    ...
    179c:	2c850513          	addi	a0,a0,712 # 6a60 <malloc+0xa36>
    ...
    17b8:	2cc50513          	addi	a0,a0,716 # 6a80 <malloc+0xa56>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	7b6080e7          	jalr	1974(ra) # 5f72 <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	20050513          	addi	a0,a0,512 # 69d0 <malloc+0x9a6>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	79a080e7          	jalr	1946(ra) # 5f72 <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	27c50513          	addi	a0,a0,636 # 6a68 <malloc+0xa3e>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	77e080e7          	jalr	1918(ra) # 5f72 <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	93e50513          	addi	a0,a0,-1730 # 6148 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1842:	25250513          	addi	a0,a0,594 # 6a90 <malloc+0xa66>
    1846:	00004097          	auipc	ra,0x4
    184a:	72c080e7          	jalr	1836(ra) # 5f72 <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	24e50513          	addi	a0,a0,590 # 6aa8 <malloc+0xa7e>
    1862:	00004097          	auipc	ra,0x4
    1866:	710080e7          	jalr	1808(ra) # 5f72 <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	1f250513          	addi	a0,a0,498 # 6a60 <malloc+0xa36>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c8050513          	addi	a0,a0,-896 # 6518 <malloc+0x4ee>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	6d2080e7          	jalr	1746(ra) # 5f72 <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	13450513          	addi	a0,a0,308 # 69e8 <malloc+0x9be>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	6b6080e7          	jalr	1718(ra) # 5f72 <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	19250513          	addi	a0,a0,402 # 6a60 <malloc+0xa36>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1c850513          	addi	a0,a0,456 # 6ac0 <malloc+0xa96>
    1900:	00004097          	auipc	ra,0x4
    1904:	672080e7          	jalr	1650(ra) # 5f72 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	12050513          	addi	a0,a0,288 # 6ad8 <malloc+0xaae>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	5b2080e7          	jalr	1458(ra) # 5f72 <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0b250513          	addi	a0,a0,178 # 6af0 <malloc+0xac6>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	52c080e7          	jalr	1324(ra) # 5f72 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	0ae50513          	addi	a0,a0,174 # 6b08 <malloc+0xade>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	510080e7          	jalr	1296(ra) # 5f72 <printf>
}
    ...
    1a90:	09450513          	addi	a0,a0,148 # 6b20 <malloc+0xaf6>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	4de080e7          	jalr	1246(ra) # 5f72 <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	07450513          	addi	a0,a0,116 # 6b40 <malloc+0xb16>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	49e080e7          	jalr	1182(ra) # 5f72 <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e9250513          	addi	a0,a0,-366 # 69d0 <malloc+0x9a6>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	42c080e7          	jalr	1068(ra) # 5f72 <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	ffe50513          	addi	a0,a0,-2 # 6b58 <malloc+0xb2e>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	410080e7          	jalr	1040(ra) # 5f72 <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	ffa50513          	addi	a0,a0,-6 # 6b70 <malloc+0xb46>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	3f4080e7          	jalr	1012(ra) # 5f72 <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	de250513          	addi	a0,a0,-542 # 69d0 <malloc+0x9a6>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	37c080e7          	jalr	892(ra) # 5f72 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	dbe50513          	addi	a0,a0,-578 # 69d0 <malloc+0x9a6>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	358080e7          	jalr	856(ra) # 5f72 <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f0450513          	addi	a0,a0,-252 # 6b90 <malloc+0xb66>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	2de080e7          	jalr	734(ra) # 5f72 <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	ebc50513          	addi	a0,a0,-324 # 6ba0 <malloc+0xb76>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	286080e7          	jalr	646(ra) # 5f72 <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	0a650513          	addi	a0,a0,166 # 6dd8 <malloc+0xdae>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	238080e7          	jalr	568(ra) # 5f72 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	00850513          	addi	a0,a0,8 # 6dd8 <malloc+0xdae>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	19a080e7          	jalr	410(ra) # 5f72 <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c6c50513          	addi	a0,a0,-916 # 6a68 <malloc+0xa3e>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	16e080e7          	jalr	366(ra) # 5f72 <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	d5250513          	addi	a0,a0,-686 # 6bc0 <malloc+0xb96>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	0fc080e7          	jalr	252(ra) # 5f72 <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	d3650513          	addi	a0,a0,-714 # 6bd8 <malloc+0xbae>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	0c8080e7          	jalr	200(ra) # 5f72 <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	cf850513          	addi	a0,a0,-776 # 6c00 <malloc+0xbd6>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	062080e7          	jalr	98(ra) # 5f72 <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	21050513          	addi	a0,a0,528 # 61b8 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	1d4a8a93          	addi	s5,s5,468 # 61b8 <malloc+0x18e>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c3cb8b93          	addi	s7,s7,-964 # 6c28 <malloc+0xbfe>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9d850513          	addi	a0,a0,-1576 # 69d0 <malloc+0x9a6>
    2000:	00004097          	auipc	ra,0x4
    2004:	f72080e7          	jalr	-142(ra) # 5f72 <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b8e50513          	addi	a0,a0,-1138 # 6c48 <malloc+0xc1e>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	eb0080e7          	jalr	-336(ra) # 5f72 <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	b1450513          	addi	a0,a0,-1260 # 6c30 <malloc+0xc06>
    2124:	00004097          	auipc	ra,0x4
    2128:	e4e080e7          	jalr	-434(ra) # 5f72 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	b3850513          	addi	a0,a0,-1224 # 6c70 <malloc+0xc46>
    2140:	00004097          	auipc	ra,0x4
    2144:	e32080e7          	jalr	-462(ra) # 5f72 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	b3450513          	addi	a0,a0,-1228 # 6c88 <malloc+0xc5e>
    215c:	00004097          	auipc	ra,0x4
    2160:	e16080e7          	jalr	-490(ra) # 5f72 <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7fc50513          	addi	a0,a0,2044 # 69d0 <malloc+0x9a6>
    21dc:	00004097          	auipc	ra,0x4
    21e0:	d96080e7          	jalr	-618(ra) # 5f72 <printf>
      exit(1);
    21e4:	4505                	li	a0,1
    ...
    21fa:	aaa50513          	addi	a0,a0,-1366 # 6ca0 <malloc+0xc76>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d74080e7          	jalr	-652(ra) # 5f72 <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	75850513          	addi	a0,a0,1880 # 69d0 <malloc+0x9a6>
    2280:	00004097          	auipc	ra,0x4
    2284:	cf2080e7          	jalr	-782(ra) # 5f72 <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	a1c50513          	addi	a0,a0,-1508 # 6cc0 <malloc+0xc96>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	cc6080e7          	jalr	-826(ra) # 5f72 <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a0450513          	addi	a0,a0,-1532 # 6cd8 <malloc+0xcae>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9d250513          	addi	a0,a0,-1582 # 6cd8 <malloc+0xcae>
  ...
  close(fd);
    ...
    2340:	9ac70713          	addi	a4,a4,-1620 # 6ce8 <malloc+0xcbe>
    ...
    2394:	a3850513          	addi	a0,a0,-1480 # 6dc8 <malloc+0xd9e>
    2398:	00004097          	auipc	ra,0x4
    239c:	bda080e7          	jalr	-1062(ra) # 5f72 <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	a3450513          	addi	a0,a0,-1484 # 6de8 <malloc+0xdbe>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	bb6080e7          	jalr	-1098(ra) # 5f72 <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9f650513          	addi	a0,a0,-1546 # 6e08 <malloc+0xdde>
    241a:	00004097          	auipc	ra,0x4
    241e:	b58080e7          	jalr	-1192(ra) # 5f72 <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	5a250513          	addi	a0,a0,1442 # 69d0 <malloc+0x9a6>
    2436:	00004097          	auipc	ra,0x4
    243a:	b3c080e7          	jalr	-1220(ra) # 5f72 <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	53450513          	addi	a0,a0,1332 # 69d0 <malloc+0x9a6>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	ace080e7          	jalr	-1330(ra) # 5f72 <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	8c050513          	addi	a0,a0,-1856 # 6dd8 <malloc+0xdae>
    2520:	00004097          	auipc	ra,0x4
    2524:	a52080e7          	jalr	-1454(ra) # 5f72 <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    25cc:	86850513          	addi	a0,a0,-1944 # 6e30 <malloc+0xe06>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	9a2080e7          	jalr	-1630(ra) # 5f72 <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	c3050513          	addi	a0,a0,-976 # 6218 <malloc+0x1ee>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	982080e7          	jalr	-1662(ra) # 5f72 <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	4a878793          	addi	a5,a5,1192 # 7b28 <malloc+0x1afe>
  ...
  if(ret != -1){
    ...
    26c6:	78650513          	addi	a0,a0,1926 # 6e48 <malloc+0xe1e>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	8a8080e7          	jalr	-1880(ra) # 5f72 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	21050513          	addi	a0,a0,528 # 68f0 <malloc+0x8c6>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	88a080e7          	jalr	-1910(ra) # 5f72 <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	21250513          	addi	a0,a0,530 # 6910 <malloc+0x8e6>
    2706:	00004097          	auipc	ra,0x4
    270a:	86c080e7          	jalr	-1940(ra) # 5f72 <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	21250513          	addi	a0,a0,530 # 6930 <malloc+0x906>
    2726:	00004097          	auipc	ra,0x4
    272a:	84c080e7          	jalr	-1972(ra) # 5f72 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	21c50513          	addi	a0,a0,540 # 6958 <malloc+0x92e>
    2744:	00004097          	auipc	ra,0x4
    2748:	82e080e7          	jalr	-2002(ra) # 5f72 <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	70050513          	addi	a0,a0,1792 # 6e88 <malloc+0xe5e>
  ...
  if(n >= 0){
    ...
    27bc:	6f050513          	addi	a0,a0,1776 # 6ea8 <malloc+0xe7e>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	7b2080e7          	jalr	1970(ra) # 5f72 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	67e50513          	addi	a0,a0,1662 # 6e50 <malloc+0xe26>
    27da:	00003097          	auipc	ra,0x3
    27de:	798080e7          	jalr	1944(ra) # 5f72 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	67c50513          	addi	a0,a0,1660 # 6e68 <malloc+0xe3e>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	77e080e7          	jalr	1918(ra) # 5f72 <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	68a50513          	addi	a0,a0,1674 # 6e90 <malloc+0xe66>
    280e:	00003097          	auipc	ra,0x3
    2812:	764080e7          	jalr	1892(ra) # 5f72 <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	65e50513          	addi	a0,a0,1630 # 6e88 <malloc+0xe5e>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	ae450513          	addi	a0,a0,-1308 # 6320 <malloc+0x2f6>
  ...
  if(n >= 0){
    ...
    286a:	67250513          	addi	a0,a0,1650 # 6ed8 <malloc+0xeae>
    286e:	00003097          	auipc	ra,0x3
    2872:	704080e7          	jalr	1796(ra) # 5f72 <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	61050513          	addi	a0,a0,1552 # 6e90 <malloc+0xe66>
    2888:	00003097          	auipc	ra,0x3
    288c:	6ea080e7          	jalr	1770(ra) # 5f72 <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	60050513          	addi	a0,a0,1536 # 6f00 <malloc+0xed6>
    2908:	00003097          	auipc	ra,0x3
    290c:	66a080e7          	jalr	1642(ra) # 5f72 <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	5ce50513          	addi	a0,a0,1486 # 6f20 <malloc+0xef6>
    295a:	00003097          	auipc	ra,0x3
    295e:	618080e7          	jalr	1560(ra) # 5f72 <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	5ca50513          	addi	a0,a0,1482 # 6f80 <malloc+0xf56>
    29be:	00003097          	auipc	ra,0x3
    29c2:	5b4080e7          	jalr	1460(ra) # 5f72 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	56850513          	addi	a0,a0,1384 # 6f40 <malloc+0xf16>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	592080e7          	jalr	1426(ra) # 5f72 <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	56c50513          	addi	a0,a0,1388 # 6f60 <malloc+0xf36>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	576080e7          	jalr	1398(ra) # 5f72 <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	46250513          	addi	a0,a0,1122 # 6fa0 <malloc+0xf76>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	42c080e7          	jalr	1068(ra) # 5f72 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	48e50513          	addi	a0,a0,1166 # 6fe8 <malloc+0xfbe>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	410080e7          	jalr	1040(ra) # 5f72 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	48e50513          	addi	a0,a0,1166 # 7008 <malloc+0xfde>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	3f0080e7          	jalr	1008(ra) # 5f72 <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	4ae50513          	addi	a0,a0,1198 # 7048 <malloc+0x101e>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	3d0080e7          	jalr	976(ra) # 5f72 <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	4c250513          	addi	a0,a0,1218 # 7078 <malloc+0x104e>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	3b4080e7          	jalr	948(ra) # 5f72 <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	4da50513          	addi	a0,a0,1242 # 70b0 <malloc+0x1086>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	394080e7          	jalr	916(ra) # 5f72 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	4c850513          	addi	a0,a0,1224 # 70d8 <malloc+0x10ae>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4b650513          	addi	a0,a0,1206 # 70d8 <malloc+0x10ae>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	46a50513          	addi	a0,a0,1130 # 70e0 <malloc+0x10b6>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	2f4080e7          	jalr	756(ra) # 5f72 <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	46650513          	addi	a0,a0,1126 # 70f8 <malloc+0x10ce>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	2d8080e7          	jalr	728(ra) # 5f72 <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	e2a50513          	addi	a0,a0,-470 # 6ad8 <malloc+0xaae>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	2bc080e7          	jalr	700(ra) # 5f72 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	43850513          	addi	a0,a0,1080 # 7110 <malloc+0x10e6>
  ...
  close(fd);
    ...
    2d24:	cc850513          	addi	a0,a0,-824 # 69e8 <malloc+0x9be>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	24a080e7          	jalr	586(ra) # 5f72 <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	06a50513          	addi	a0,a0,106 # 6dd8 <malloc+0xdae>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1fc080e7          	jalr	508(ra) # 5f72 <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	01450513          	addi	a0,a0,20 # 6dd8 <malloc+0xdae>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	1a6080e7          	jalr	422(ra) # 5f72 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	fb450513          	addi	a0,a0,-76 # 6dd8 <malloc+0xdae>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	146080e7          	jalr	326(ra) # 5f72 <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e4050513          	addi	a0,a0,-448 # 6dd8 <malloc+0xdae>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	fd2080e7          	jalr	-46(ra) # 5f72 <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	15c50513          	addi	a0,a0,348 # 6148 <malloc+0x11e>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1c078793          	addi	a5,a5,448 # 61b8 <malloc+0x18e>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	2be50513          	addi	a0,a0,702 # 72e8 <malloc+0x12be>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	10450513          	addi	a0,a0,260 # 7140 <malloc+0x1116>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	14650513          	addi	a0,a0,326 # 7198 <malloc+0x116e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	1a050513          	addi	a0,a0,416 # 7210 <malloc+0x11e6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1f450513          	addi	a0,a0,500 # 7280 <malloc+0x1256>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	23a50513          	addi	a0,a0,570 # 72d8 <malloc+0x12ae>
  ...
  unlink("12345678901234");
    ...
    3120:	ffc50513          	addi	a0,a0,-4 # 7118 <malloc+0x10ee>
    3124:	00003097          	auipc	ra,0x3
    3128:	e4e080e7          	jalr	-434(ra) # 5f72 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	02850513          	addi	a0,a0,40 # 7160 <malloc+0x1136>
    3140:	00003097          	auipc	ra,0x3
    3144:	e32080e7          	jalr	-462(ra) # 5f72 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	07450513          	addi	a0,a0,116 # 71c8 <malloc+0x119e>
    315c:	00003097          	auipc	ra,0x3
    3160:	e16080e7          	jalr	-490(ra) # 5f72 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	0d050513          	addi	a0,a0,208 # 7240 <malloc+0x1216>
    3178:	00003097          	auipc	ra,0x3
    317c:	dfa080e7          	jalr	-518(ra) # 5f72 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	11450513          	addi	a0,a0,276 # 72a0 <malloc+0x1276>
    3194:	00003097          	auipc	ra,0x3
    3198:	dde080e7          	jalr	-546(ra) # 5f72 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	15050513          	addi	a0,a0,336 # 72f8 <malloc+0x12ce>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	dc2080e7          	jalr	-574(ra) # 5f72 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	13c50513          	addi	a0,a0,316 # 7330 <malloc+0x1306>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	12250513          	addi	a0,a0,290 # 7340 <malloc+0x1316>
    3226:	00003097          	auipc	ra,0x3
    322a:	d4c080e7          	jalr	-692(ra) # 5f72 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	08250513          	addi	a0,a0,130 # 7330 <malloc+0x1306>
  ...
  unlink("diskfulldir");
    ...
    32c6:	06e50513          	addi	a0,a0,110 # 7330 <malloc+0x1306>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f7050513          	addi	a0,a0,-144 # 7360 <malloc+0x1336>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b7a080e7          	jalr	-1158(ra) # 5f72 <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f8250513          	addi	a0,a0,-126 # 7390 <malloc+0x1366>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f6e50513          	addi	a0,a0,-146 # 7390 <malloc+0x1366>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f9a50513          	addi	a0,a0,-102 # 73d0 <malloc+0x13a6>
  ...
  if(chdir("/") < 0){
    ...
    344e:	fb650513          	addi	a0,a0,-74 # 7400 <malloc+0x13d6>
    ...
    346e:	f2e50513          	addi	a0,a0,-210 # 7398 <malloc+0x136e>
    3472:	00003097          	auipc	ra,0x3
    3476:	b00080e7          	jalr	-1280(ra) # 5f72 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	f2a50513          	addi	a0,a0,-214 # 73b0 <malloc+0x1386>
    348e:	00003097          	auipc	ra,0x3
    3492:	ae4080e7          	jalr	-1308(ra) # 5f72 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	f3e50513          	addi	a0,a0,-194 # 73e0 <malloc+0x13b6>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	ac8080e7          	jalr	-1336(ra) # 5f72 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	f4a50513          	addi	a0,a0,-182 # 7408 <malloc+0x13de>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	aac080e7          	jalr	-1364(ra) # 5f72 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e9e50513          	addi	a0,a0,-354 # 7390 <malloc+0x1366>
    ...
    350a:	e8a50513          	addi	a0,a0,-374 # 7390 <malloc+0x1366>
    ...
    351e:	eb650513          	addi	a0,a0,-330 # 73d0 <malloc+0x13a6>
    ...
    353e:	49650513          	addi	a0,a0,1174 # 69d0 <malloc+0x9a6>
    3542:	00003097          	auipc	ra,0x3
    3546:	a30080e7          	jalr	-1488(ra) # 5f72 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	e4250513          	addi	a0,a0,-446 # 7398 <malloc+0x136e>
    355e:	00003097          	auipc	ra,0x3
    3562:	a14080e7          	jalr	-1516(ra) # 5f72 <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	eae50513          	addi	a0,a0,-338 # 7420 <malloc+0x13f6>
    357a:	00003097          	auipc	ra,0x3
    357e:	9f8080e7          	jalr	-1544(ra) # 5f72 <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e5250513          	addi	a0,a0,-430 # 73e0 <malloc+0x13b6>
    3596:	00003097          	auipc	ra,0x3
    359a:	9dc080e7          	jalr	-1572(ra) # 5f72 <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e6c50513          	addi	a0,a0,-404 # 7438 <malloc+0x140e>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e5850513          	addi	a0,a0,-424 # 7438 <malloc+0x140e>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e6450513          	addi	a0,a0,-412 # 7458 <malloc+0x142e>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e3050513          	addi	a0,a0,-464 # 7438 <malloc+0x140e>
    ...
    362c:	d7050513          	addi	a0,a0,-656 # 7398 <malloc+0x136e>
    3630:	00003097          	auipc	ra,0x3
    3634:	942080e7          	jalr	-1726(ra) # 5f72 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dfc50513          	addi	a0,a0,-516 # 7440 <malloc+0x1416>
    364c:	00003097          	auipc	ra,0x3
    3650:	926080e7          	jalr	-1754(ra) # 5f72 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	e0050513          	addi	a0,a0,-512 # 7460 <malloc+0x1436>
    3668:	00003097          	auipc	ra,0x3
    366c:	90a080e7          	jalr	-1782(ra) # 5f72 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dfc50513          	addi	a0,a0,-516 # 7478 <malloc+0x144e>
    3684:	00003097          	auipc	ra,0x3
    3688:	8ee080e7          	jalr	-1810(ra) # 5f72 <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f1c50513          	addi	a0,a0,-228 # 75c0 <malloc+0x1596>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	ddc50513          	addi	a0,a0,-548 # 7490 <malloc+0x1466>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	de450513          	addi	a0,a0,-540 # 74b0 <malloc+0x1486>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	edc58593          	addi	a1,a1,-292 # 75c0 <malloc+0x1596>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d9250513          	addi	a0,a0,-622 # 7490 <malloc+0x1466>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	df650513          	addi	a0,a0,-522 # 7508 <malloc+0x14de>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e0650513          	addi	a0,a0,-506 # 7530 <malloc+0x1506>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e1e58593          	addi	a1,a1,-482 # 7560 <malloc+0x1536>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e0a50513          	addi	a0,a0,-502 # 7568 <malloc+0x153e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e1258593          	addi	a1,a1,-494 # 75b8 <malloc+0x158e>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d8250513          	addi	a0,a0,-638 # 7530 <malloc+0x1506>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d6e50513          	addi	a0,a0,-658 # 7530 <malloc+0x1506>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d5850513          	addi	a0,a0,-680 # 7530 <malloc+0x1506>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	ca450513          	addi	a0,a0,-860 # 7490 <malloc+0x1466>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e5050513          	addi	a0,a0,-432 # 7650 <malloc+0x1626>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e6c50513          	addi	a0,a0,-404 # 7680 <malloc+0x1656>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e8850513          	addi	a0,a0,-376 # 76b0 <malloc+0x1686>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d7a50513          	addi	a0,a0,-646 # 75b8 <malloc+0x158e>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	cb850513          	addi	a0,a0,-840 # 7530 <malloc+0x1506>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	eb050513          	addi	a0,a0,-336 # 7740 <malloc+0x1716>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	ec850513          	addi	a0,a0,-312 # 7770 <malloc+0x1746>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	bd050513          	addi	a0,a0,-1072 # 7490 <malloc+0x1466>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	bba50513          	addi	a0,a0,-1094 # 7490 <malloc+0x1466>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	ba450513          	addi	a0,a0,-1116 # 7490 <malloc+0x1466>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f0058593          	addi	a1,a1,-256 # 7800 <malloc+0x17d6>
    3908:	00004517          	auipc	a0,0x4
    390c:	e3850513          	addi	a0,a0,-456 # 7740 <malloc+0x1716>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	ee458593          	addi	a1,a1,-284 # 7800 <malloc+0x17d6>
    3924:	00004517          	auipc	a0,0x4
    3928:	e4c50513          	addi	a0,a0,-436 # 7770 <malloc+0x1746>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c8058593          	addi	a1,a1,-896 # 75b8 <malloc+0x158e>
    3940:	00004517          	auipc	a0,0x4
    3944:	b7050513          	addi	a0,a0,-1168 # 74b0 <malloc+0x1486>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	dec50513          	addi	a0,a0,-532 # 7740 <malloc+0x1716>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e0850513          	addi	a0,a0,-504 # 7770 <malloc+0x1746>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c3c50513          	addi	a0,a0,-964 # 75b8 <malloc+0x158e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	de050513          	addi	a0,a0,-544 # 7770 <malloc+0x1746>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d9c50513          	addi	a0,a0,-612 # 7740 <malloc+0x1716>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	af850513          	addi	a0,a0,-1288 # 74b0 <malloc+0x1486>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f8450513          	addi	a0,a0,-124 # 7950 <malloc+0x1926>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	bd850513          	addi	a0,a0,-1064 # 75b8 <malloc+0x158e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	abc50513          	addi	a0,a0,-1348 # 74b0 <malloc+0x1486>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a8850513          	addi	a0,a0,-1400 # 7490 <malloc+0x1466>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	fa450513          	addi	a0,a0,-92 # 79c0 <malloc+0x1996>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a6050513          	addi	a0,a0,-1440 # 7490 <malloc+0x1466>
    ...
    3a56:	a4650513          	addi	a0,a0,-1466 # 7498 <malloc+0x146e>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	518080e7          	jalr	1304(ra) # 5f72 <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	a4a50513          	addi	a0,a0,-1462 # 74b8 <malloc+0x148e>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4fc080e7          	jalr	1276(ra) # 5f72 <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	a4e50513          	addi	a0,a0,-1458 # 74d8 <malloc+0x14ae>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	4e0080e7          	jalr	1248(ra) # 5f72 <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a6a50513          	addi	a0,a0,-1430 # 7510 <malloc+0x14e6>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	4c4080e7          	jalr	1220(ra) # 5f72 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a7e50513          	addi	a0,a0,-1410 # 7540 <malloc+0x1516>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	4a8080e7          	jalr	1192(ra) # 5f72 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a9a50513          	addi	a0,a0,-1382 # 7578 <malloc+0x154e>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	48c080e7          	jalr	1164(ra) # 5f72 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a9e50513          	addi	a0,a0,-1378 # 7598 <malloc+0x156e>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	470080e7          	jalr	1136(ra) # 5f72 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	ab250513          	addi	a0,a0,-1358 # 75c8 <malloc+0x159e>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	454080e7          	jalr	1108(ra) # 5f72 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	abe50513          	addi	a0,a0,-1346 # 75f0 <malloc+0x15c6>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	438080e7          	jalr	1080(ra) # 5f72 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	ac250513          	addi	a0,a0,-1342 # 7610 <malloc+0x15e6>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	41c080e7          	jalr	1052(ra) # 5f72 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	ace50513          	addi	a0,a0,-1330 # 7638 <malloc+0x160e>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	400080e7          	jalr	1024(ra) # 5f72 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	ada50513          	addi	a0,a0,-1318 # 7660 <malloc+0x1636>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	3e4080e7          	jalr	996(ra) # 5f72 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	aee50513          	addi	a0,a0,-1298 # 7690 <malloc+0x1666>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	3c8080e7          	jalr	968(ra) # 5f72 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	afa50513          	addi	a0,a0,-1286 # 76b8 <malloc+0x168e>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	3ac080e7          	jalr	940(ra) # 5f72 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	af650513          	addi	a0,a0,-1290 # 76d0 <malloc+0x16a6>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	390080e7          	jalr	912(ra) # 5f72 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	afa50513          	addi	a0,a0,-1286 # 76f0 <malloc+0x16c6>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	374080e7          	jalr	884(ra) # 5f72 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	afe50513          	addi	a0,a0,-1282 # 7710 <malloc+0x16e6>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	358080e7          	jalr	856(ra) # 5f72 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	b2250513          	addi	a0,a0,-1246 # 7750 <malloc+0x1726>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	33c080e7          	jalr	828(ra) # 5f72 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	b3650513          	addi	a0,a0,-1226 # 7780 <malloc+0x1756>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	320080e7          	jalr	800(ra) # 5f72 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	b3a50513          	addi	a0,a0,-1222 # 77a0 <malloc+0x1776>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	304080e7          	jalr	772(ra) # 5f72 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	b3e50513          	addi	a0,a0,-1218 # 77c0 <malloc+0x1796>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	2e8080e7          	jalr	744(ra) # 5f72 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	b4250513          	addi	a0,a0,-1214 # 77e0 <malloc+0x17b6>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	2cc080e7          	jalr	716(ra) # 5f72 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b5650513          	addi	a0,a0,-1194 # 7810 <malloc+0x17e6>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	2b0080e7          	jalr	688(ra) # 5f72 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b6250513          	addi	a0,a0,-1182 # 7838 <malloc+0x180e>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	294080e7          	jalr	660(ra) # 5f72 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b6e50513          	addi	a0,a0,-1170 # 7860 <malloc+0x1836>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	278080e7          	jalr	632(ra) # 5f72 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b7a50513          	addi	a0,a0,-1158 # 7888 <malloc+0x185e>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	25c080e7          	jalr	604(ra) # 5f72 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b7e50513          	addi	a0,a0,-1154 # 78a8 <malloc+0x187e>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	240080e7          	jalr	576(ra) # 5f72 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b8250513          	addi	a0,a0,-1150 # 78c8 <malloc+0x189e>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	224080e7          	jalr	548(ra) # 5f72 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b8e50513          	addi	a0,a0,-1138 # 78f0 <malloc+0x18c6>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	208080e7          	jalr	520(ra) # 5f72 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b9250513          	addi	a0,a0,-1134 # 7910 <malloc+0x18e6>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	1ec080e7          	jalr	492(ra) # 5f72 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b9650513          	addi	a0,a0,-1130 # 7930 <malloc+0x1906>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	1d0080e7          	jalr	464(ra) # 5f72 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	ba250513          	addi	a0,a0,-1118 # 7958 <malloc+0x192e>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	1b4080e7          	jalr	436(ra) # 5f72 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	81e50513          	addi	a0,a0,-2018 # 75f0 <malloc+0x15c6>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	198080e7          	jalr	408(ra) # 5f72 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b8a50513          	addi	a0,a0,-1142 # 7978 <malloc+0x194e>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	17c080e7          	jalr	380(ra) # 5f72 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b8e50513          	addi	a0,a0,-1138 # 7998 <malloc+0x196e>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	160080e7          	jalr	352(ra) # 5f72 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	ba250513          	addi	a0,a0,-1118 # 79c8 <malloc+0x199e>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	144080e7          	jalr	324(ra) # 5f72 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	ba650513          	addi	a0,a0,-1114 # 79e8 <malloc+0x19be>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	128080e7          	jalr	296(ra) # 5f72 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b9850513          	addi	a0,a0,-1128 # 7a00 <malloc+0x19d6>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b8650513          	addi	a0,a0,-1146 # 7a00 <malloc+0x19d6>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	9a450513          	addi	a0,a0,-1628 # 6830 <malloc+0x806>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	5ba50513          	addi	a0,a0,1466 # 7458 <malloc+0x142e>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	55050513          	addi	a0,a0,1360 # 7400 <malloc+0x13d6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	ba650513          	addi	a0,a0,-1114 # 7a68 <malloc+0x1a3e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	bbc50513          	addi	a0,a0,-1092 # 7a90 <malloc+0x1a66>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b1a50513          	addi	a0,a0,-1254 # 7a00 <malloc+0x19d6>
    ...
    3f08:	b0450513          	addi	a0,a0,-1276 # 7a08 <malloc+0x19de>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	066080e7          	jalr	102(ra) # 5f72 <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	b0050513          	addi	a0,a0,-1280 # 7a20 <malloc+0x19f6>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	04a080e7          	jalr	74(ra) # 5f72 <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	afc50513          	addi	a0,a0,-1284 # 7a38 <malloc+0x1a0e>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	02e080e7          	jalr	46(ra) # 5f72 <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	af850513          	addi	a0,a0,-1288 # 7a50 <malloc+0x1a26>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	012080e7          	jalr	18(ra) # 5f72 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	49450513          	addi	a0,a0,1172 # 7408 <malloc+0x13de>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	ff6080e7          	jalr	-10(ra) # 5f72 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	ae050513          	addi	a0,a0,-1312 # 7a70 <malloc+0x1a46>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	fda080e7          	jalr	-38(ra) # 5f72 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	aec50513          	addi	a0,a0,-1300 # 7a98 <malloc+0x1a6e>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	fbe080e7          	jalr	-66(ra) # 5f72 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	af050513          	addi	a0,a0,-1296 # 7ab8 <malloc+0x1a8e>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	fa2080e7          	jalr	-94(ra) # 5f72 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	ae450513          	addi	a0,a0,-1308 # 7ad8 <malloc+0x1aae>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	ac850513          	addi	a0,a0,-1336 # 7ad8 <malloc+0x1aae>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	afc50513          	addi	a0,a0,-1284 # 7b20 <malloc+0x1af6>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	ae450513          	addi	a0,a0,-1308 # 7b20 <malloc+0x1af6>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	ad050513          	addi	a0,a0,-1328 # 7b20 <malloc+0x1af6>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	abc50513          	addi	a0,a0,-1348 # 7b20 <malloc+0x1af6>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	aa858593          	addi	a1,a1,-1368 # 7b20 <malloc+0x1af6>
    4080:	00002517          	auipc	a0,0x2
    4084:	2a050513          	addi	a0,a0,672 # 6320 <malloc+0x2f6>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a4450513          	addi	a0,a0,-1468 # 7ad8 <malloc+0x1aae>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	78650513          	addi	a0,a0,1926 # 6830 <malloc+0x806>
  ...
  fd = open(".", 0);
    ...
    40c4:	77050513          	addi	a0,a0,1904 # 6830 <malloc+0x806>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0e458593          	addi	a1,a1,228 # 61b8 <malloc+0x18e>
  ...
  close(fd);
    ...
    4104:	9e050513          	addi	a0,a0,-1568 # 7ae0 <malloc+0x1ab6>
    4108:	00002097          	auipc	ra,0x2
    410c:	e6a080e7          	jalr	-406(ra) # 5f72 <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	9e450513          	addi	a0,a0,-1564 # 7b00 <malloc+0x1ad6>
    4124:	00002097          	auipc	ra,0x2
    4128:	e4e080e7          	jalr	-434(ra) # 5f72 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9f850513          	addi	a0,a0,-1544 # 7b30 <malloc+0x1b06>
    4140:	00002097          	auipc	ra,0x2
    4144:	e32080e7          	jalr	-462(ra) # 5f72 <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	9dc50513          	addi	a0,a0,-1572 # 7b30 <malloc+0x1b06>
    415c:	00002097          	auipc	ra,0x2
    4160:	e16080e7          	jalr	-490(ra) # 5f72 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9e850513          	addi	a0,a0,-1560 # 7b58 <malloc+0x1b2e>
    4178:	00002097          	auipc	ra,0x2
    417c:	dfa080e7          	jalr	-518(ra) # 5f72 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9f450513          	addi	a0,a0,-1548 # 7b80 <malloc+0x1b56>
    4194:	00002097          	auipc	ra,0x2
    4198:	dde080e7          	jalr	-546(ra) # 5f72 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	a0050513          	addi	a0,a0,-1536 # 7ba8 <malloc+0x1b7e>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	dc2080e7          	jalr	-574(ra) # 5f72 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	a0c50513          	addi	a0,a0,-1524 # 7bd0 <malloc+0x1ba6>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	da6080e7          	jalr	-602(ra) # 5f72 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	a1050513          	addi	a0,a0,-1520 # 7bf0 <malloc+0x1bc6>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d8a080e7          	jalr	-630(ra) # 5f72 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	a1c50513          	addi	a0,a0,-1508 # 7c18 <malloc+0x1bee>
    4204:	00002097          	auipc	ra,0x2
    4208:	d6e080e7          	jalr	-658(ra) # 5f72 <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	a00a0a13          	addi	s4,s4,-1536 # 7c30 <malloc+0x1c06>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	50048493          	addi	s1,s1,1280 # 7738 <malloc+0x170e>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0e0a8a93          	addi	s5,s5,224 # 6320 <malloc+0x2f6>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8e098993          	addi	s3,s3,-1824 # 7b28 <malloc+0x1afe>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9e450513          	addi	a0,a0,-1564 # 7c38 <malloc+0x1c0e>
    425c:	00002097          	auipc	ra,0x2
    4260:	d16080e7          	jalr	-746(ra) # 5f72 <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	9e050513          	addi	a0,a0,-1568 # 7c50 <malloc+0x1c26>
    4278:	00002097          	auipc	ra,0x2
    427c:	cfa080e7          	jalr	-774(ra) # 5f72 <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	15498993          	addi	s3,s3,340 # 7458 <malloc+0x142e>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	92490913          	addi	s2,s2,-1756 # 7c30 <malloc+0x1c06>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0d450513          	addi	a0,a0,212 # 7400 <malloc+0x13d6>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	90c50513          	addi	a0,a0,-1780 # 7c68 <malloc+0x1c3e>
  ...
  if(pid == 0){
    ...
    4384:	8e850513          	addi	a0,a0,-1816 # 7c68 <malloc+0x1c3e>
    ...
    439a:	8f250513          	addi	a0,a0,-1806 # 7c88 <malloc+0x1c5e>
    439e:	00002097          	auipc	ra,0x2
    43a2:	bd4080e7          	jalr	-1068(ra) # 5f72 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	8be50513          	addi	a0,a0,-1858 # 7c70 <malloc+0x1c46>
    43ba:	00002097          	auipc	ra,0x2
    43be:	bb8080e7          	jalr	-1096(ra) # 5f72 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	60250513          	addi	a0,a0,1538 # 69d0 <malloc+0x9a6>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b9c080e7          	jalr	-1124(ra) # 5f72 <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	86c50513          	addi	a0,a0,-1940 # 7c68 <malloc+0x1c3e>
    ...
    4414:	7b050513          	addi	a0,a0,1968 # 6bc0 <malloc+0xb96>
    4418:	00002097          	auipc	ra,0x2
    441c:	b5a080e7          	jalr	-1190(ra) # 5f72 <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	86250513          	addi	a0,a0,-1950 # 7cb0 <malloc+0x1c86>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	83650513          	addi	a0,a0,-1994 # 7cb0 <malloc+0x1c86>
  ...
  sleep(10); // one second
    ...
    44b6:	6de50513          	addi	a0,a0,1758 # 6b90 <malloc+0xb66>
    44ba:	00002097          	auipc	ra,0x2
    44be:	ab8080e7          	jalr	-1352(ra) # 5f72 <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	7e448493          	addi	s1,s1,2020 # 7cb0 <malloc+0x1c86>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	45c50513          	addi	a0,a0,1116 # 69d0 <malloc+0x9a6>
    457c:	00002097          	auipc	ra,0x2
    4580:	9f6080e7          	jalr	-1546(ra) # 5f72 <printf>
      exit(1);
    4584:	4505                	li	a0,1
    ...
    459e:	72650513          	addi	a0,a0,1830 # 7cc0 <malloc+0x1c96>
    45a2:	00002097          	auipc	ra,0x2
    45a6:	9d0080e7          	jalr	-1584(ra) # 5f72 <printf>
       exit(1);
    45aa:	4505                	li	a0,1
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	5b650513          	addi	a0,a0,1462 # 6b90 <malloc+0xb66>
    45e2:	00002097          	auipc	ra,0x2
    45e6:	990080e7          	jalr	-1648(ra) # 5f72 <printf>
    exit(1);
    45ea:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    460c:	3c850513          	addi	a0,a0,968 # 69d0 <malloc+0x9a6>
    4610:	00002097          	auipc	ra,0x2
    4614:	962080e7          	jalr	-1694(ra) # 5f72 <printf>
    exit(1);
    4618:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4650:	b6c58593          	addi	a1,a1,-1172 # 61b8 <malloc+0x18e>
    ...
    467a:	35a50513          	addi	a0,a0,858 # 69d0 <malloc+0x9a6>
    467e:	00002097          	auipc	ra,0x2
    4682:	8f4080e7          	jalr	-1804(ra) # 5f72 <printf>
     exit(1);
    4686:	4505                	li	a0,1
    ...
    4696:	64e50513          	addi	a0,a0,1614 # 7ce0 <malloc+0x1cb6>
    469a:	00002097          	auipc	ra,0x2
    469e:	8d8080e7          	jalr	-1832(ra) # 5f72 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	62a50513          	addi	a0,a0,1578 # 7cf8 <malloc+0x1cce>
    46d6:	00002097          	auipc	ra,0x2
    46da:	89c080e7          	jalr	-1892(ra) # 5f72 <printf>
}
  ...
  printf("kill... ");
    ...
    46fe:	61650513          	addi	a0,a0,1558 # 7d10 <malloc+0x1ce6>
    4702:	00002097          	auipc	ra,0x2
    4706:	870080e7          	jalr	-1936(ra) # 5f72 <printf>
  kill(pid1);
    470a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    472c:	5f850513          	addi	a0,a0,1528 # 7d20 <malloc+0x1cf6>
    4730:	00002097          	auipc	ra,0x2
    4734:	842080e7          	jalr	-1982(ra) # 5f72 <printf>
  wait(0);
    4738:	4501                	li	a0,0
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	22850513          	addi	a0,a0,552 # 69d0 <malloc+0x9a6>
    47b0:	00001097          	auipc	ra,0x1
    47b4:	7c2080e7          	jalr	1986(ra) # 5f72 <printf>
      exit(1);
    47b8:	4505                	li	a0,1
    ...
    47c8:	39450513          	addi	a0,a0,916 # 6b58 <malloc+0xb2e>
    47cc:	00001097          	auipc	ra,0x1
    47d0:	7a6080e7          	jalr	1958(ra) # 5f72 <printf>
        exit(1);
    47d4:	4505                	li	a0,1
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	29e50513          	addi	a0,a0,670 # 6ad8 <malloc+0xaae>
    4842:	00001097          	auipc	ra,0x1
    4846:	730080e7          	jalr	1840(ra) # 5f72 <printf>
    exit(1);
    484a:	4505                	li	a0,1
    ...
    4872:	94a58593          	addi	a1,a1,-1718 # 61b8 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	3fe50513          	addi	a0,a0,1022 # 7d30 <malloc+0x1d06>
    493a:	00001097          	auipc	ra,0x1
    493e:	638080e7          	jalr	1592(ra) # 5f72 <printf>
    exit(1);
    4942:	4505                	li	a0,1
    ...
    4952:	08250513          	addi	a0,a0,130 # 69d0 <malloc+0x9a6>
    4956:	00001097          	auipc	ra,0x1
    495a:	61c080e7          	jalr	1564(ra) # 5f72 <printf>
    exit(1);
    495e:	4505                	li	a0,1
    ...
    499e:	3b650513          	addi	a0,a0,950 # 7d50 <malloc+0x1d26>
    49a2:	00001097          	auipc	ra,0x1
    49a6:	5d0080e7          	jalr	1488(ra) # 5f72 <printf>
    exit(1);
    49aa:	4505                	li	a0,1
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a08:	626080e7          	jalr	1574(ra) # 602a <malloc>
    ...
    4a42:	34250513          	addi	a0,a0,834 # 7d80 <malloc+0x1d56>
    4a46:	00001097          	auipc	ra,0x1
    4a4a:	52c080e7          	jalr	1324(ra) # 5f72 <printf>
      exit(1);
    4a4e:	4505                	li	a0,1
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	2bc50513          	addi	a0,a0,700 # 7db0 <malloc+0x1d86>
    4afc:	00001097          	auipc	ra,0x1
    4b00:	476080e7          	jalr	1142(ra) # 5f72 <printf>
    exit(1);
    4b04:	4505                	li	a0,1
    ...
    4b14:	2c850513          	addi	a0,a0,712 # 7dd8 <malloc+0x1dae>
    4b18:	00001097          	auipc	ra,0x1
    4b1c:	45a080e7          	jalr	1114(ra) # 5f72 <printf>
      exit(1);
    4b20:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	24c50513          	addi	a0,a0,588 # 7da0 <malloc+0x1d76>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	26450513          	addi	a0,a0,612 # 7df8 <malloc+0x1dce>
    4b9c:	00001097          	auipc	ra,0x1
    4ba0:	3d6080e7          	jalr	982(ra) # 5f72 <printf>
    exit(1);
    4ba4:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bd4:	1d050513          	addi	a0,a0,464 # 7da0 <malloc+0x1d76>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	22a50513          	addi	a0,a0,554 # 7e20 <malloc+0x1df6>
    4bfe:	00001097          	auipc	ra,0x1
    4c02:	374080e7          	jalr	884(ra) # 5f72 <printf>
    exit(1);
    4c06:	4505                	li	a0,1
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	1fc78793          	addi	a5,a5,508 # 7e38 <malloc+0x1e0e>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	1f878793          	addi	a5,a5,504 # 7e40 <malloc+0x1e16>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	1f478793          	addi	a5,a5,500 # 7e48 <malloc+0x1e1e>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	1f078793          	addi	a5,a5,496 # 7e50 <malloc+0x1e26>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	10050513          	addi	a0,a0,256 # 6dd8 <malloc+0xdae>
    4ce0:	00001097          	auipc	ra,0x1
    4ce4:	292080e7          	jalr	658(ra) # 5f72 <printf>
      exit(1);
    4ce8:	4505                	li	a0,1
    ...
    4d58:	10450513          	addi	a0,a0,260 # 7e58 <malloc+0x1e2e>
    4d5c:	00001097          	auipc	ra,0x1
    4d60:	216080e7          	jalr	534(ra) # 5f72 <printf>
        exit(1);
    4d64:	4505                	li	a0,1
    ...
    4d72:	0fa50513          	addi	a0,a0,250 # 7e68 <malloc+0x1e3e>
    4d76:	00001097          	auipc	ra,0x1
    4d7a:	1fc080e7          	jalr	508(ra) # 5f72 <printf>
          exit(1);
    4d7e:	4505                	li	a0,1
    ...
    4d9a:	0ea50513          	addi	a0,a0,234 # 7e80 <malloc+0x1e56>
    4d9e:	00001097          	auipc	ra,0x1
    4da2:	1d4080e7          	jalr	468(ra) # 5f72 <printf>
          exit(1);
    4da6:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	06c50513          	addi	a0,a0,108 # 7e90 <malloc+0x1e66>
    4e2c:	00001097          	auipc	ra,0x1
    4e30:	146080e7          	jalr	326(ra) # 5f72 <printf>
      exit(1);
    4e34:	4505                	li	a0,1
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	022b8b93          	addi	s7,s7,34 # 7ea8 <malloc+0x1e7e>
  for(i = 0; i < N; i++){
    ...
    4ecc:	fe850513          	addi	a0,a0,-24 # 7eb0 <malloc+0x1e86>
    4ed0:	00001097          	auipc	ra,0x1
    4ed4:	0a2080e7          	jalr	162(ra) # 5f72 <printf>
        exit(1);
    4ed8:	4505                	li	a0,1
    ...
    4eea:	fc250513          	addi	a0,a0,-62 # 7ea8 <malloc+0x1e7e>
  ...
  fd = open(".", 0);
    ...
    4f22:	91250513          	addi	a0,a0,-1774 # 6830 <malloc+0x806>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	f3a50513          	addi	a0,a0,-198 # 7ed0 <malloc+0x1ea6>
    4f9e:	00001097          	auipc	ra,0x1
    4fa2:	fd4080e7          	jalr	-44(ra) # 5f72 <printf>
        exit(1);
    4fa6:	4505                	li	a0,1
    ...
    4fba:	f3a50513          	addi	a0,a0,-198 # 7ef0 <malloc+0x1ec6>
    4fbe:	00001097          	auipc	ra,0x1
    4fc2:	fb4080e7          	jalr	-76(ra) # 5f72 <printf>
        exit(1);
    4fc6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	f2a50513          	addi	a0,a0,-214 # 7f18 <malloc+0x1eee>
    4ff6:	00001097          	auipc	ra,0x1
    4ffa:	f7c080e7          	jalr	-132(ra) # 5f72 <printf>
    exit(1);
    4ffe:	4505                	li	a0,1
    ...
    500e:	9c650513          	addi	a0,a0,-1594 # 69d0 <malloc+0x9a6>
    5012:	00001097          	auipc	ra,0x1
    5016:	f60080e7          	jalr	-160(ra) # 5f72 <printf>
      exit(1);
    501a:	4505                	li	a0,1
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	d1450513          	addi	a0,a0,-748 # 7f50 <malloc+0x1f26>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	cc050513          	addi	a0,a0,-832 # 7f60 <malloc+0x1f36>
    52a8:	00001097          	auipc	ra,0x1
    52ac:	cca080e7          	jalr	-822(ra) # 5f72 <printf>
    exit(1);
    52b0:	4505                	li	a0,1
    ...
    52c0:	cc450513          	addi	a0,a0,-828 # 7f80 <malloc+0x1f56>
    52c4:	00001097          	auipc	ra,0x1
    52c8:	cae080e7          	jalr	-850(ra) # 5f72 <printf>
      exit(1);
    52cc:	4505                	li	a0,1
    ...
    52dc:	cc850513          	addi	a0,a0,-824 # 7fa0 <malloc+0x1f76>
    52e0:	00001097          	auipc	ra,0x1
    52e4:	c92080e7          	jalr	-878(ra) # 5f72 <printf>
    exit(1);
    52e8:	4505                	li	a0,1
    ...
    52f8:	ccc50513          	addi	a0,a0,-820 # 7fc0 <malloc+0x1f96>
    52fc:	00001097          	auipc	ra,0x1
    5300:	c76080e7          	jalr	-906(ra) # 5f72 <printf>
      exit(1);
    5304:	4505                	li	a0,1
    ...
    5314:	cd050513          	addi	a0,a0,-816 # 7fe0 <malloc+0x1fb6>
    5318:	00001097          	auipc	ra,0x1
    531c:	c5a080e7          	jalr	-934(ra) # 5f72 <printf>
      exit(1);
    5320:	4505                	li	a0,1
    ...
    5330:	ccc50513          	addi	a0,a0,-820 # 7ff8 <malloc+0x1fce>
    5334:	00001097          	auipc	ra,0x1
    5338:	c3e080e7          	jalr	-962(ra) # 5f72 <printf>
      exit(1);
    533c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    535e:	bf650513          	addi	a0,a0,-1034 # 7f50 <malloc+0x1f26>
    ...
    5382:	c9a50513          	addi	a0,a0,-870 # 8018 <malloc+0x1fee>
    5386:	00001097          	auipc	ra,0x1
    538a:	bec080e7          	jalr	-1044(ra) # 5f72 <printf>
    exit(1);
    538e:	4505                	li	a0,1
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	c8250513          	addi	a0,a0,-894 # 8038 <malloc+0x200e>
    53be:	00001097          	auipc	ra,0x1
    53c2:	bb4080e7          	jalr	-1100(ra) # 5f72 <printf>
  for(nfiles = 0; ; nfiles++){
    53c6:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53da:	c72c8c93          	addi	s9,s9,-910 # 8048 <malloc+0x201e>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5432:	b44080e7          	jalr	-1212(ra) # 5f72 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5454:	c0850513          	addi	a0,a0,-1016 # 8058 <malloc+0x202e>
    5458:	00001097          	auipc	ra,0x1
    545c:	b1a080e7          	jalr	-1254(ra) # 5f72 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	bb250513          	addi	a0,a0,-1102 # 8078 <malloc+0x204e>
    54ce:	00001097          	auipc	ra,0x1
    54d2:	aa4080e7          	jalr	-1372(ra) # 5f72 <printf>
}
    ...
    551a:	b5250513          	addi	a0,a0,-1198 # 8068 <malloc+0x203e>
    551e:	00001097          	auipc	ra,0x1
    5522:	a54080e7          	jalr	-1452(ra) # 5f72 <printf>
    close(fd);
    5526:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	b4850513          	addi	a0,a0,-1208 # 8090 <malloc+0x2066>
    5550:	00001097          	auipc	ra,0x1
    5554:	a22080e7          	jalr	-1502(ra) # 5f72 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    557c:	b4050513          	addi	a0,a0,-1216 # 80b8 <malloc+0x208e>
    5580:	00001097          	auipc	ra,0x1
    5584:	9f2080e7          	jalr	-1550(ra) # 5f72 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a0:	b0450513          	addi	a0,a0,-1276 # 80a0 <malloc+0x2076>
    55a4:	00001097          	auipc	ra,0x1
    55a8:	9ce080e7          	jalr	-1586(ra) # 5f72 <printf>
    exit(1);
    55ac:	4505                	li	a0,1
    ...
    55c8:	afc50513          	addi	a0,a0,-1284 # 80c0 <malloc+0x2096>
    55cc:	00001097          	auipc	ra,0x1
    55d0:	9a6080e7          	jalr	-1626(ra) # 5f72 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	ab450513          	addi	a0,a0,-1356 # 80c8 <malloc+0x209e>
    561c:	00001097          	auipc	ra,0x1
    5620:	956080e7          	jalr	-1706(ra) # 5f72 <printf>
        return 1;
    5624:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5672:	b4a98993          	addi	s3,s3,-1206 # 61b8 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a4:	a8050513          	addi	a0,a0,-1408 # 8120 <malloc+0x20f6>
    56a8:	00001097          	auipc	ra,0x1
    56ac:	8ca080e7          	jalr	-1846(ra) # 5f72 <printf>
        exit(1);
    56b0:	4505                	li	a0,1
    ...
    56be:	a2650513          	addi	a0,a0,-1498 # 80e0 <malloc+0x20b6>
    56c2:	00001097          	auipc	ra,0x1
    56c6:	8b0080e7          	jalr	-1872(ra) # 5f72 <printf>
    exit(1);
    56ca:	4505                	li	a0,1
    ...
    56d8:	a2c50513          	addi	a0,a0,-1492 # 8100 <malloc+0x20d6>
    56dc:	00001097          	auipc	ra,0x1
    56e0:	896080e7          	jalr	-1898(ra) # 5f72 <printf>
    exit(1);
    56e4:	4505                	li	a0,1
  ...
  while(1){
    ...
    5726:	a1e50513          	addi	a0,a0,-1506 # 8140 <malloc+0x2116>
    572a:	00001097          	auipc	ra,0x1
    572e:	848080e7          	jalr	-1976(ra) # 5f72 <printf>
      exit(1);
    5732:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	9dcb8b93          	addi	s7,s7,-1572 # 8160 <malloc+0x2136>
    int free0 = countfree();
    int free1 = 0;
    ...
    57d2:	7a4080e7          	jalr	1956(ra) # 5f72 <printf>
    int free0 = countfree();
    ...
    5822:	754080e7          	jalr	1876(ra) # 5f72 <printf>
      if(continuous != 2) {
    ...
    5832:	744080e7          	jalr	1860(ra) # 5f72 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    589e:	92e58593          	addi	a1,a1,-1746 # 81c8 <malloc+0x219e>
    ...
    58b6:	96e58593          	addi	a1,a1,-1682 # 8220 <malloc+0x21f6>
    ...
    58cc:	95058593          	addi	a1,a1,-1712 # 8218 <malloc+0x21ee>
  ...
  int continuous = 0;
    ...
    58f8:	8dc50513          	addi	a0,a0,-1828 # 81d0 <malloc+0x21a6>
    58fc:	00000097          	auipc	ra,0x0
    5900:	676080e7          	jalr	1654(ra) # 5f72 <printf>
    exit(1);
    5904:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	8e050513          	addi	a0,a0,-1824 # 8200 <malloc+0x21d6>
    5928:	00000097          	auipc	ra,0x0
    592c:	64a080e7          	jalr	1610(ra) # 5f72 <printf>
  exit(0);
    5930:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c98:	1101                	addi	sp,sp,-32
    5c9a:	ec06                	sd	ra,24(sp)
    5c9c:	e822                	sd	s0,16(sp)
    5c9e:	1000                	addi	s0,sp,32
    5ca0:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5ca4:	4605                	li	a2,1
    5ca6:	fef40593          	addi	a1,s0,-17
    5caa:	00000097          	auipc	ra,0x0
    5cae:	f36080e7          	jalr	-202(ra) # 5be0 <write>
}
    5cb2:	60e2                	ld	ra,24(sp)
    5cb4:	6442                	ld	s0,16(sp)
    5cb6:	6105                	addi	sp,sp,32
    5cb8:	8082                	ret

0000000000005cba <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5cba:	7139                	addi	sp,sp,-64
    5cbc:	fc06                	sd	ra,56(sp)
    5cbe:	f822                	sd	s0,48(sp)
    5cc0:	f426                	sd	s1,40(sp)
    5cc2:	f04a                	sd	s2,32(sp)
    5cc4:	ec4e                	sd	s3,24(sp)
    5cc6:	0080                	addi	s0,sp,64
    5cc8:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5cca:	c299                	beqz	a3,5cd0 <printint+0x16>
    5ccc:	0805c963          	bltz	a1,5d5e <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5cd0:	2581                	sext.w	a1,a1
  neg = 0;
    5cd2:	4881                	li	a7,0
    5cd4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5cda:	2601                	sext.w	a2,a2
    5cdc:	00003517          	auipc	a0,0x3
    5ce0:	90c50513          	addi	a0,a0,-1780 # 85e8 <digits>
    5ce4:	883a                	mv	a6,a4
    5ce6:	2705                	addiw	a4,a4,1
    5ce8:	02c5f7bb          	remuw	a5,a1,a2
    5cec:	1782                	slli	a5,a5,0x20
    5cee:	9381                	srli	a5,a5,0x20
    5cf0:	97aa                	add	a5,a5,a0
    5cf2:	0007c783          	lbu	a5,0(a5)
    5cf6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5cfa:	0005879b          	sext.w	a5,a1
    5cfe:	02c5d5bb          	divuw	a1,a1,a2
    5d02:	0685                	addi	a3,a3,1
    5d04:	fec7f0e3          	bgeu	a5,a2,5ce4 <printint+0x2a>
  if(neg)
    5d08:	00088c63          	beqz	a7,5d20 <printint+0x66>
    buf[i++] = '-';
    5d0c:	fd070793          	addi	a5,a4,-48
    5d10:	00878733          	add	a4,a5,s0
    5d14:	02d00793          	li	a5,45
    5d18:	fef70823          	sb	a5,-16(a4)
    5d1c:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5d20:	02e05863          	blez	a4,5d50 <printint+0x96>
    ...
    5d46:	f56080e7          	jalr	-170(ra) # 5c98 <putc>
  while(--i >= 0)
    5d4a:	197d                	addi	s2,s2,-1
    5d4c:	ff3918e3          	bne	s2,s3,5d3c <printint+0x82>
}
    ...
    5d62:	4885                	li	a7,1
    x = -xx;
    5d64:	bf85                	j	5cd4 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d9a:	4c55                	li	s8,21
    5d9c:	00002c97          	auipc	s9,0x2
    5da0:	7f4c8c93          	addi	s9,s9,2036 # 8590 <malloc+0x2566>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5da4:	02800d93          	li	s11,40
  putc(fd, 'x');
    5da8:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5daa:	00003b97          	auipc	s7,0x3
    5dae:	83eb8b93          	addi	s7,s7,-1986 # 85e8 <digits>
    5db2:	a839                	j	5dd0 <vprintf+0x6a>
        putc(fd, c);
    5db4:	85ca                	mv	a1,s2
    5db6:	8556                	mv	a0,s5
    5db8:	00000097          	auipc	ra,0x0
    5dbc:	ee0080e7          	jalr	-288(ra) # 5c98 <putc>
    5dc0:	a019                	j	5dc6 <vprintf+0x60>
    } else if(state == '%'){
    5dc2:	01498d63          	beq	s3,s4,5ddc <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5dc6:	0485                	addi	s1,s1,1
    5dc8:	fff4c903          	lbu	s2,-1(s1)
    5dcc:	14090d63          	beqz	s2,5f26 <vprintf+0x1c0>
    if(state == 0){
    5dd0:	fe0999e3          	bnez	s3,5dc2 <vprintf+0x5c>
      if(c == '%'){
    5dd4:	ff4910e3          	bne	s2,s4,5db4 <vprintf+0x4e>
        state = '%';
    5dd8:	89d2                	mv	s3,s4
    5dda:	b7f5                	j	5dc6 <vprintf+0x60>
      if(c == 'd'){
    5ddc:	11490c63          	beq	s2,s4,5ef4 <vprintf+0x18e>
    5de0:	f9d9079b          	addiw	a5,s2,-99
    5de4:	0ff7f793          	zext.b	a5,a5
    5de8:	10fc6e63          	bltu	s8,a5,5f04 <vprintf+0x19e>
    5dec:	f9d9079b          	addiw	a5,s2,-99
    5df0:	0ff7f713          	zext.b	a4,a5
    5df4:	10ec6863          	bltu	s8,a4,5f04 <vprintf+0x19e>
    5df8:	00271793          	slli	a5,a4,0x2
    5dfc:	97e6                	add	a5,a5,s9
    5dfe:	439c                	lw	a5,0(a5)
    5e00:	97e6                	add	a5,a5,s9
    5e02:	8782                	jr	a5
    ...
    5e16:	ea8080e7          	jalr	-344(ra) # 5cba <printint>
    5e1a:	8b4a                	mv	s6,s2
      } else {
    ...
    5e32:	e8c080e7          	jalr	-372(ra) # 5cba <printint>
    5e36:	8b4a                	mv	s6,s2
      state = 0;
    5e38:	4981                	li	s3,0
    ...
    5e4e:	e70080e7          	jalr	-400(ra) # 5cba <printint>
    5e52:	8b4a                	mv	s6,s2
      state = 0;
    5e54:	4981                	li	s3,0
    5e56:	bf85                	j	5dc6 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5e58:	008b0793          	addi	a5,s6,8
    5e5c:	f8f43423          	sd	a5,-120(s0)
    5e60:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e64:	03000593          	li	a1,48
    5e68:	8556                	mv	a0,s5
    5e6a:	00000097          	auipc	ra,0x0
    5e6e:	e2e080e7          	jalr	-466(ra) # 5c98 <putc>
  putc(fd, 'x');
    5e72:	07800593          	li	a1,120
    5e76:	8556                	mv	a0,s5
    5e78:	00000097          	auipc	ra,0x0
    5e7c:	e20080e7          	jalr	-480(ra) # 5c98 <putc>
    5e80:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5e92:	e0a080e7          	jalr	-502(ra) # 5c98 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e96:	0992                	slli	s3,s3,0x4
    5e98:	397d                	addiw	s2,s2,-1
    5e9a:	fe0914e3          	bnez	s2,5e82 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5e9e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5ea2:	4981                	li	s3,0
    5ea4:	b70d                	j	5dc6 <vprintf+0x60>
        s = va_arg(ap, char*);
    5ea6:	008b0913          	addi	s2,s6,8
    5eaa:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5eae:	02098163          	beqz	s3,5ed0 <vprintf+0x16a>
        while(*s != 0){
    5eb2:	0009c583          	lbu	a1,0(s3)
    5eb6:	c5ad                	beqz	a1,5f20 <vprintf+0x1ba>
          putc(fd, *s);
    5eb8:	8556                	mv	a0,s5
    5eba:	00000097          	auipc	ra,0x0
    5ebe:	dde080e7          	jalr	-546(ra) # 5c98 <putc>
          s++;
    5ec2:	0985                	addi	s3,s3,1
        while(*s != 0){
    5ec4:	0009c583          	lbu	a1,0(s3)
    5ec8:	f9e5                	bnez	a1,5eb8 <vprintf+0x152>
        s = va_arg(ap, char*);
    5eca:	8b4a                	mv	s6,s2
      state = 0;
    5ecc:	4981                	li	s3,0
    5ece:	bde5                	j	5dc6 <vprintf+0x60>
          s = "(null)";
    5ed0:	00002997          	auipc	s3,0x2
    5ed4:	6b898993          	addi	s3,s3,1720 # 8588 <malloc+0x255e>
        while(*s != 0){
    5ed8:	85ee                	mv	a1,s11
    5eda:	bff9                	j	5eb8 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5edc:	008b0913          	addi	s2,s6,8
    5ee0:	000b4583          	lbu	a1,0(s6)
    5ee4:	8556                	mv	a0,s5
    5ee6:	00000097          	auipc	ra,0x0
    5eea:	db2080e7          	jalr	-590(ra) # 5c98 <putc>
    5eee:	8b4a                	mv	s6,s2
      state = 0;
    5ef0:	4981                	li	s3,0
    5ef2:	bdd1                	j	5dc6 <vprintf+0x60>
        putc(fd, c);
    5ef4:	85d2                	mv	a1,s4
    5ef6:	8556                	mv	a0,s5
    5ef8:	00000097          	auipc	ra,0x0
    5efc:	da0080e7          	jalr	-608(ra) # 5c98 <putc>
      state = 0;
    5f00:	4981                	li	s3,0
    5f02:	b5d1                	j	5dc6 <vprintf+0x60>
        putc(fd, '%');
    5f04:	85d2                	mv	a1,s4
    5f06:	8556                	mv	a0,s5
    5f08:	00000097          	auipc	ra,0x0
    5f0c:	d90080e7          	jalr	-624(ra) # 5c98 <putc>
        putc(fd, c);
    5f10:	85ca                	mv	a1,s2
    5f12:	8556                	mv	a0,s5
    5f14:	00000097          	auipc	ra,0x0
    5f18:	d84080e7          	jalr	-636(ra) # 5c98 <putc>
      state = 0;
    5f1c:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5fba:	a02d                	j	5fe4 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fbc:	4618                	lw	a4,8(a2)
    5fbe:	9f2d                	addw	a4,a4,a1
    5fc0:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fc4:	6398                	ld	a4,0(a5)
    5fc6:	6310                	ld	a2,0(a4)
    5fc8:	a83d                	j	6006 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fca:	ff852703          	lw	a4,-8(a0)
    5fce:	9f31                	addw	a4,a4,a2
    5fd0:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5fd2:	ff053683          	ld	a3,-16(a0)
    5fd6:	a091                	j	601a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fd8:	6398                	ld	a4,0(a5)
    5fda:	00e7e463          	bltu	a5,a4,5fe2 <free+0x3a>
    5fde:	00e6ea63          	bltu	a3,a4,5ff2 <free+0x4a>
{
    5fe2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fe4:	fed7fae3          	bgeu	a5,a3,5fd8 <free+0x30>
    5fe8:	6398                	ld	a4,0(a5)
    5fea:	00e6e463          	bltu	a3,a4,5ff2 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fee:	fee7eae3          	bltu	a5,a4,5fe2 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5ff2:	ff852583          	lw	a1,-8(a0)
    5ff6:	6390                	ld	a2,0(a5)
    5ff8:	02059813          	slli	a6,a1,0x20
    5ffc:	01c85713          	srli	a4,a6,0x1c
    6000:	9736                	add	a4,a4,a3
    6002:	fae60de3          	beq	a2,a4,5fbc <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    6006:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    600a:	4790                	lw	a2,8(a5)
    600c:	02061593          	slli	a1,a2,0x20
    6010:	01c5d713          	srli	a4,a1,0x1c
    6014:	973e                	add	a4,a4,a5
    6016:	fae68ae3          	beq	a3,a4,5fca <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    6098:	b7e1                	j	6060 <malloc+0x36>
      if(p->s.size == nunits)
    609a:	02e48c63          	beq	s1,a4,60d2 <malloc+0xa8>
        p->s.size -= nunits;
    609e:	4137073b          	subw	a4,a4,s3
    60a2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    60a4:	02071693          	slli	a3,a4,0x20
    60a8:	01c6d713          	srli	a4,a3,0x1c
    ...
    60d6:	bff1                	j	60b2 <malloc+0x88>
  hp->s.size = nu;
    60d8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60dc:	0541                	addi	a0,a0,16
    60de:	00000097          	auipc	ra,0x0
    60e2:	eca080e7          	jalr	-310(ra) # 5fa8 <free>
  return freep;
    60e6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60ea:	d971                	beqz	a0,60be <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60ec:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60ee:	4798                	lw	a4,8(a5)
    60f0:	fa9775e3          	bgeu	a4,s1,609a <malloc+0x70>
    if(p == freep)
    60f4:	00093703          	ld	a4,0(s2)
    60f8:	853e                	mv	a0,a5
    60fa:	fef719e3          	bne	a4,a5,60ec <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    60fe:	8552                	mv	a0,s4
    6100:	00000097          	auipc	ra,0x0
    6104:	b48080e7          	jalr	-1208(ra) # 5c48 <sbrk>
  if(p == (char*)-1)
    6108:	fd5518e3          	bne	a0,s5,60d8 <malloc+0xae>
        return 0;
    610c:	4501                	li	a0,0
    610e:	bf45                	j	60be <malloc+0x94>
