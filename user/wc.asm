...
wc(int fd, char *name)
{
  ...
  3c:	938a0a13          	addi	s4,s4,-1736 # 970 <malloc+0xea>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	8d250513          	addi	a0,a0,-1838 # 988 <malloc+0x102>
  ...
  e8:	89450513          	addi	a0,a0,-1900 # 978 <malloc+0xf2>
...
main(int argc, char *argv[])
{
 ...
 162:	83a58593          	addi	a1,a1,-1990 # 998 <malloc+0x112>
 166:	4501                	li	a0,0
 ...
 180:	82450513          	addi	a0,a0,-2012 # 9a0 <malloc+0x11a>
...
putc(int fd, char c)
{
 ...
 50a:	f36080e7          	jalr	-202(ra) # 43c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 53c:	4e050513          	addi	a0,a0,1248 # a18 <digits>
 540:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5fc:	3c8c8c93          	addi	s9,s9,968 # 9c0 <malloc+0x13a>
 ...
 60a:	412b8b93          	addi	s7,s7,1042 # a18 <digits>
 ...
 730:	28c98993          	addi	s3,s3,652 # 9b8 <malloc+0x132>
        while(*s != 0){
 734:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 8e2:	93278793          	addi	a5,a5,-1742 # 1210 <base>
 ...
 960:	b48080e7          	jalr	-1208(ra) # 4a4 <sbrk>
  if(p == (char*)-1)
